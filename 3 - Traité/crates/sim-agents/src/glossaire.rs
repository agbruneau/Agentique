...
pub fn glossaire() -> &'static [Terme] {
    ...
    &[
        ...
        Terme {
            ...
            provenance: "§1.3, tableau 3, p. 18 (4ᵉ éd.)",
        },
        Terme {
            groupe: DEUX_REGIMES,
            terme: "journal",
            ...
            provenance: "§1.3 ; figure 0, p. 4 (4ᵉ éd.)",
        },
        Terme {
            groupe: DEUX_REGIMES,
            terme: "milieu",
        ...
        Terme {
            ...
            // le §8.3 du **traité** porte sur les buts incompatibles (p. 124, 4ᵉ éd.), pas
        ...
        Terme {
            ...
            definition:
                "propriété d'une action qu'on peut refaire sans dommage. C'est le seul recours \
                 ...
                 jamais levée.",
            provenance: "§5.1, et conclusion p. 129 (4ᵉ éd.)",
        },
        Terme {
            groupe: JUGEMENT,
            terme: "rejeu",
