...
| Statut | **P0, P1 et P2 exécutées et closes (jalons J-1, J-2 et J-3).** P3 à P5 restent ☐. Le volume possède son arborescence, son gabarit, et **un socle propre de 78 entrées re-mesurées** ; **les quinze lots d'instruction sont clos**. **Aucune pièce n'est rédigée** — la phase suivante est la première à produire de la prose d'ouvrage. |
| Documents de gouvernance | [`PRD.md`](PRD.md) **v1.0** — autorité de contenu, socle, garde-fous, critères d'acceptation ; [`TOC.md`](TOC.md) v0.6 — autorité de découpage ; [`CLAUDE.md`](../../../CLAUDE.md) racine — conventions du dépôt |
...
**Décompte de contrôle (21 juillet 2026, après clôture de P2)** : 34 unités de rédaction — **0 rédigée, 0 relue, 34 au gabarit**. Socle propre : **78 entrées re-mesurées** (F-01 à F-78). **Lots clos : 15 sur 15.** Affirmations instruites : **180** ; soumises au vote adversarial : **80** ; **écartées : 17**. Corrections de bornage : **53**. Échecs de source consignés : **106**. Remontées de gouvernance tranchées : **4**. Phases : **P0, P1 et P2 closes**, P3 à P5 ☐.

⚠ **La règle cardinale ne bloque plus aucun chapitre — et c'est le moment où elle protège le moins.** Les quinze lots étant clos, plus aucune pièce n'est interdite d'écriture par §7.0. Ce qui demeure, ce sont les **dépendances éditoriales** du §5.1 : le ch. 4 ouvre l'ouvrage, le ch. 8 se rédige **après** le ch. 9, les six chapitres de composition attendent leurs chapitres amont. *Un socle constitué autorise la rédaction ; il ne la planifie pas.*
