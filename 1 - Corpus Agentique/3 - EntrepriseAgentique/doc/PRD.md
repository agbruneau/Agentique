...
| Statut | **Socle propre constitué sur les deux lots bloquants ; rédaction non commencée.** Le volume porte **26 entrées propres** (§7.8) et 33 entrées héritées (§7.2, §7.3). Sur ses 15 lots d'instruction (§7.6), **trois sont clos** — L-03 et L-08 par instruction aboutie, L-15 par échec documenté ; **douze restent ouverts**. **Deux chapitres deviennent rédigeables** : le **ch. 5** (L-03 clos) et le **ch. 12** (L-08 clos). Tous les autres restent sous la règle cardinale (§7.0). Les 34 pièces existent au **gabarit** ; un gabarit n'est ni un brouillon ni une ébauche. |
...
| Corpus | **26 entrées vérifiées par ce volume** (§7.8), issues de sources primaires ouvertes et citées ; 33 entrées héritées, dont 16 du Vol. II (13 à niveau conservé, 3 hors socle factuel) et 17 du Vol. I (**entrant en [C]**, §7.1). Corpus d'appui : **3 ouvrages annoncés, 0 déposé, filiation retirée le 21 juillet 2026** (§7.7). |
...
Échéances et leurs sources, **avec le statut réel du document qui les porte** ; *harvest now, decrypt later* appliqué aux artefacts d'identité longue durée ; inventaire des artefacts qui cassent ; crypto-agilité comme application de l'invariant du Vol. I à la couche cryptographique ; audit de crypto-agilité des mécanismes de la Partie II ; **patrons de migration sans rupture de la chaîne de confiance** *(complément **C-4**, 21 juillet 2026 : porté par l'Annexe B §B.1 principe 7, il manquait ici)* ; dette de migration — ce que les sources portent, la méthode d'estimation plutôt qu'un chiffre.
...
**Cardinal du socle propre : 26** (mis à jour le 21 juillet 2026, à la clôture de P1 — voir **§7.8**). Les entrées **F-01 à F-12** proviennent du lot L-03, les entrées **F-13 à F-26** du lot L-08. ⚠ Les treize lots restants n'ayant pas été instruits, ce cardinal **croîtra en P2** : il est re-mesuré à chaque clôture de lot, **jamais dérivé d'une borne d'identifiants**.
...
| indéterminée | Statut des conventions sémantiques OpenTelemetry pour les agents ~~(expérimental → stable)~~ — ⚠ **échelle corrigée le 21 juillet 2026** : OpenTelemetry gradue **Development → Release Candidate → Stable**, et les attributs GenAI sont au **premier** échelon. L'alternative binaire « expérimental / stable » était mal calibrée | ch. 24 |
...
| SCIM-agents / brouillon CSA | **inchangé et renforcé** / **ÉVOLUÉ** | Aucune consolidation IETF ; le document est *expired & archived*, jamais adopté par un WG. **Le brouillon CSA a été mis à jour le 20 mai 2026 : H-03 s'amende au socle, et L-05 réinstruit avant le ch. 7** |
...
| Conventions OTel | **ÉVOLUÉ** | Conventions déplacées dans un dépôt dédié, statut **Development** ; L-14 établit version, date et dépôt |
...
**État au 21 juillet 2026, à la clôture de P1.** Sur les quatorze lacunes, **quatre sont closes** — la **1** et la **2** par instruction aboutie (lots L-03 et L-08), la **11** par instruction infructueuse et décision, la **12** par décision — et **dix demeurent, dont aucune n'est instruite**. Chacune devient soit un encadré « état de la connaissance vérifiable », soit une question de recherche explicite (CA-06). ⚠ **Une lacune close ne disparaît pas de l'ouvrage** : elle change de gabarit — « passe conduite » au lieu de « aucune passe conduite » —, et **les quatorze continuent d'apparaître** (CA-06, point 4 de la Definition of Done). ⚠ *(Chapeau redaté à la relecture P1.4 : il affirmait encore « aucune n'est instruite » trois lignes au-dessus de quatre clôtures datées.)*
