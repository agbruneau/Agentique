...
| Socle mobilisé (PRD §7) | H-01 |
| Garde-fous à surveiller (PRD §8) | **R-02 — porteuse critique** (un mécanisme cryptographique est qualifié par ce que sa spécification **démontre**) ; R-01 |
...
Lot d'instruction : **L-03 — bloquant au sens fort**
