...
| Socle mobilisé (PRD §7) | H-33 |
| Garde-fous à surveiller (PRD §8) | **R-14 — siège du vocabulaire des trois degrés d'absence** ; R-10 (armé, sans objet à date) ; **seuil de vote abaissé et déclaré** (PRD §A.4) ; porte la lacune 12 — `commun/faits-partages.md`, close par décision et non par instruction |
...
Lot d'instruction : aucun — pièce d'appareil
