...
| **Note de synthèse** — `3 - Veille/Note de synthèse.pdf`, son contrôle `3 - Veille/Python/check-synthese.py` et son harnais | RED, LOG, VER : bâtisseur M8 de la boucle bâtisseur / critique du 15 septembre 2026, Claude Opus 5 [P] (statut en tête de la note) ; soumise au critique de la même boucle ; **aucun humain ne l'a relue** | non commitée à la rédaction, 15 sept. 2026 | — | Pandoc 3.11, Typst 0.15.1, Python |
...
| **Résumés anglais** — la page « Abstract » des dix documents publiés qui portent un résumé français : Vol. I, II, III, V, VI, VII et VIII, note SDLC, note de synthèse, article HPC-QPU | RED : traduits du résumé français avec assistance de modèle — bâtisseur M9 de la boucle du 15 septembre 2026, Claude Opus 5, tâche T7.1 ; **aucun humain ne les a relus** | non commités à la rédaction, 15 sept. 2026 | — | Pandoc 3.11, Typst 0.15.1 |
...
5. **Relecture humaine : aucune.** Les niveaux de preuve **[A]** des PRD reposent sur des votes
