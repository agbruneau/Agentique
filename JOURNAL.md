...
Le texte d'origine se relit par `git show 5cdb5bb:"README.md"`. Trois dossiers ont changé de nom le 5 septembre 2026 — `3 - Traité/` est
...
|---|---|---|
| [`README.md`](#page-readme) | 499 | [État au 15 septembre 2026](#état-au-15-septembre-2026) · [Chronique datée](#chronique-datée) · [Par où entrer, selon le temps qu'on a](#par-où-entrer-selon-le-temps-quon-a) · [Les sept livrables](#les-sept-livrables) · [Carte du dépôt](#carte-du-dépôt) |

<a id="page-readme"></a>

---

*Page reçue : `README.md`, 499 lignes au commit `5cdb5bb`.*
