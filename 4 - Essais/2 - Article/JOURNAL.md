...
Le texte d'origine se relit par `git show 5cdb5bb:"4 - Essais/2 - Article/README.md"`. Trois dossiers ont changé de nom le 5 septembre 2026 — `3 - Traité/` est
...
|---|---|---|
| [`README.md`](#page-readme) | 179 | [Ce qu'il soutient](#ce-quil-soutient) · [Ce que le dossier porte](#ce-que-le-dossier-porte) · [Refaire le PDF](#refaire-le-pdf) · [Les contrôles](#les-contrôles) · [Deux relevés de métadonnées](#deux-relevés-de-métadonnées) |

<a id="page-readme"></a>

---

*Page reçue : `README.md`, 179 lignes au commit `5cdb5bb`.*
