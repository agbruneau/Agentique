...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 5.5](#en-tête-de-rédaction) |
|---|---|
...
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gel de source juin 2026 (Vol. I) ; au gel unique, l'édition de contexte reste en bêta, l'outil de mémoire est en disponibilité générale |
| **Socle mobilisé** | aucune entrée, faute de couverture (fait négatif vérifié) ; résout contre le Vol. I, §2.6-2.7, en [C] |
| **Garde-fous balayés** | Vol. II — R-1 à R-8 : zéro occurrence · Vol. III — R-01 à R-13 : zéro occurrence ; R-14 : deux occurrences |
| **Volumétrie cible** | Réel : 4 896 mots de corps pour une cible ≈ 7 500 mots (−34,7 %), mesure `decompte.sh` |
