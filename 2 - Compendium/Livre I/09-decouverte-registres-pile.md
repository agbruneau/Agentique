...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 9.6](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé hors portes le 27 juillet 2026, non ré-adossé au socle consolidé ; régime [C], CA-IV-13 insatisfaite ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gel de source juin 2026 (Vol. I) ; la matrice de maturité du § 9.2.5 se périme en bloc |
| **Socle mobilisé** | aucune entrée, faute de couverture ; résout contre le Vol. I, §3.4, §3.5, §3.7-3.8 et §3.12, en [C] |
| **Garde-fous balayés** | Vol. II — R-1 : une occurrence ; R-8 : une occurrence ; R-2 à R-7 : zéro occurrence · Vol. III — R-02 : deux occurrences ; R-13 : une occurrence ; R-14 : quatre occurrences ; R-01, R-03 à R-12 : zéro occurrence |
| **Volumétrie cible** | Réel : 6 185 mots de corps pour une cible ≈ 9 000 mots (−31,3 %), mesure `decompte.sh` |
...
⚠ Que ces deux propositions vaillent au-delà du cas historique dont elles sont tirées n'est pas
...
> versionnement et dépréciation **comme les protocoles qu'il indexe** : l'invariant du Livre s'applique
...
> un imposteur. ⚠ **Qualification, au sens de R-02 du Vol. III** : une signature de provenance **démontre**
...
L'interface **Chat Completions d'OpenAI** — le point d'extrémité `/v1/chat/completions` et le
...
> vingt-sept jours de la date d'arrêt satisfait-il le critère du PROGRAMMÉ du § 49.0 ?* ☑ **RÉPONDU
> OUI, et la rangée est inscrite — 2 septembre 2026** (D-16). *Le critère est celui du **ch. 49
> § 49.0**, siège du tri, et il n'est pas repris ici* : une date de retrait annoncée par le
> responsable de l'objet, publiquement, un an à l'avance, **y satisfait sans réserve**. ⚠ **Le tableau 50.1 porte donc quatorze
> événements et non onze**, et *celui-ci est le seul dont la date soit PASSÉE au moment où on
> l'inscrit.* **La proximité à la date d'arrêt n'était pas le critère** : *elle rendait l'objet
> urgent, elle ne le rendait pas éligible ; c'est la nature de l'engagement qui le rend éligible.* Chez
...
- **la dérive de vocabulaire entre versions** — une capacité change de sens d'une révision à l'autre
  **sans que le contrat formel le signale**, brisant le troisième terme de l'invariant ;
...
| Champ | Valeur |
|---|---|
| **Statut** | **Brouillon de rédaction, non publiable** — rédigé le 27 juillet 2026 sur instruction d'auteur, **portes G-1, G-2 et G-3 alors ouvertes**. ⚠ **Mise à jour du 28 juillet 2026** : **G-2, le volet Livre I de G-1 et désormais G-3 sont franchis** — le socle consolidé existe ([`socle-consolide.md`](../PRD/socle-consolide.md) v1.2, **159 entrées** `S-001`…`S-159` ; PRD v0.14) —, et les **remontées de cette pièce sont closes**. ⚠ **Le franchissement de G-3 ne rend pas cette pièce recevable, et c'est le point à ne pas lire trop vite** : *ses énoncés n'ont pas été ré-adossés au socle consolidé*, la résolution demeure celle du champ ci-dessous, en régime **[C]**, **aucun énoncé n'est central au sens de CA-IV-01**, et **CA-IV-13 reste insatisfaite** faute de relecteur distinct du rédacteur. *Une porte franchie n'est pas une pièce recevable ; c'est une condition qui cesse de manquer.* |
