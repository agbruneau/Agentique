...
Cette pile fournit la grille de lecture de la somme entière. Chaque mécanisme étudié plus loin se situe sur l'un de ces paliers — les formats et schémas au ch. 2, la sémantique et les ontologies au ch. 2 également, la coordination organisationnelle des processus ici même (§ 1.6), et les protocoles agentiques au ch. 8. ⚠ **Elle prépare aussi le constat le plus important du Livre I** : MCP et A2A opèrent au niveau syntaxique et, partiellement, technique ; ils ne fournissent aucun mécanisme d'accord sémantique, qu'ils **présupposent**. Ce constat est établi au ch. 8 et au ch. 9 ; il est ici seulement rendu formulable.
...
Les transactions réparties confrontent l'intégrateur à des limites théoriques établies. Sous partition réseau, cohérence forte et disponibilité ne peuvent coexister. Le protocole de validation à deux phases offre l'atomicité distribuée, mais au prix d'un verrouillage synchrone qui bloque les participants pendant la coordination ; un résultat d'impossibilité classique montre par ailleurs qu'aucun consensus déterministe n'est garanti en présence d'asynchronie et de défaillances, ce qui fragilise le coordonnateur lui-même.

Le patron **saga** renonce à l'atomicité globale au profit d'une suite de transactions locales, chacune assortie d'une **compensation** qui annule sémantiquement son effet en cas d'échec ultérieur. La saga se décline en variante **orchestrée** — un coordonnateur séquence les étapes et déclenche les compensations — et **chorégraphiée** — chaque étape réagit aux événements précédents.
...
**Ce qui est enfreint.** Le PRD §5 pose que « aucun chapitre ne se rédige avant que G-1, G-2 et G-3 soient franchies », et §6 place les Livres I et III en premier **après** ces portes. Les trois sont ouvertes : gel unique non fixé (D-1), commande de décompte non validée sur les trois corpus (G-2), socle consolidé à 0 entrée (G-3). Ce chapitre a donc été écrit **sur instruction d'auteur** avant ses préalables, et il en porte les quatre conséquences suivantes.

1. **Aucun énoncé n'est central au sens de CA-IV-01.** Faute d'Annexe B, aucune affirmation ne résout contre une entrée de socle numérotée. Les énoncés factuels héritent du régime [C] du Vol. I (PRD §7.1) et **doivent être élevés en [B] par lecture des sources primaires que le Vol. I cite** avant toute publication.
2. **Aucun décompte de ce chapitre n'est publiable** (G-2). La volumétrie annoncée en tête est une enveloppe, pas une mesure.
3. **Les renvois aux chapitres aval sont des renvois de plan, non de texte.** Les ch. 2, 3, 9, 22, 29, 37, 38, 43, 48 et 49 ne sont pas rédigés : chaque « voir ch. N » résout contre l'entrée du TOC v0.23, jamais contre une pièce. ⚠ Ils se re-vérifient contre le texte lorsqu'il existera — un renvoi de plan qui survit à la rédaction du chapitre cible sans être revérifié est exactement le défaut que la décision 8 du TOC proscrit.
4. **Deux remontées de gouvernance sont ouvertes par cette rédaction**, à l'instance d'arbitrage (D-6, elle-même non désignée) :
