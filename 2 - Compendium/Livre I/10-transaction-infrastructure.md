...
**Sur les quatre objets que l'encadré distingue, deux ne relèvent pas du champ
...
cardinal** — § 10.1.2, § 10.2.1 et § 10.2.3 —, chacune attribuée à son communiqué **et** porteuse de la
clause « soutien ≠ production ».
...
2026**, que `check-compendium.py` refuserait au commit. Les trois remontées sont donc **décrites par
leur objet** ; **leur numérotation revient à la passe qui les consolide**.
