...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 6.6](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé hors portes le 27 juillet 2026 et malgré la remontée bloquante R-IV-01 ; non ré-adossé au socle, CA-IV-13 due ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gel de source juin 2026 (Vol. I) ; trois faits datés à re-vérifier |
| **Socle mobilisé** | non adossée au socle entrée par entrée ; résout contre le Vol. I, §2.8.1-2.8.3, §2.9.1-2.9.5 et §2.10.3-2.10.5, en [C] |
| **Garde-fous balayés** | Vol. II — R-8 : une occurrence ; R-1 à R-7 : zéro occurrence · Vol. III — R-13 : une occurrence ; R-14 : quatre occurrences ; R-01 à R-12 : zéro occurrence |
| **Volumétrie cible** | Réel : 4 605 mots de corps pour une cible ≈ 8 500 mots (−45,8 %), mesure `decompte.sh` |
...
2025, **a convergé dans A2A** ; un troisième effort, amorcé par **Cisco**, vise une interopérabilité
...
**SC00037J** énumère les actes communicatifs, chacun assorti d'une précondition, d'un effet
...
l'invulnérabilité — illusoire — mais la défense en profondeur**, en supposant que toute couche finisse
par être éprouvée.
...
six** : cadriciels d'orchestration au ch. 23, choix et service du modèle au ch. 4 (**arrivée déclarée
