...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 3.5](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé hors portes le 27 juillet 2026, non ré-adossé au socle consolidé ; aucun vote adversarial, G-4 à G-6 ouvertes, CA-IV-11 et CA-IV-13 insatisfaites ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gel de source juin 2026 (Vol. I) ; trois faits datés à re-vérifier, dont OAuth 2.1 encore en projet |
| **Socle mobilisé** | aucune entrée, ré-adossement dû ; résout contre le Vol. I, §1.9-1.10, en [C] — réserve renforcée sur la matière cryptographique |
| **Garde-fous balayés** | Vol. II — R-1 à R-8 : zéro occurrence · Vol. III — R-02 : quatre occurrences ; R-11 : une occurrence ; R-14 : deux occurrences ; R-13 : le marqueur figure une fois ; R-01, R-03 à R-10, R-12 : zéro occurrence |
| **Volumétrie cible** | Réel : 5 734 mots de corps pour une cible ≈ 9 000 mots (−36,3 %), mesure `decompte.sh` |
...
> OAuth 2.1 avec preuve de clé obligatoire pour l'autorisation déléguée constitue le choix par défaut
...
⚠ **C'est ici que se joue la thèse du chapitre**, et cela vaut d'être dit au moment où le mécanisme est
...
Anticipant la menace que ferait peser un calculateur quantique sur les algorithmes asymétriques actuels,
...
- **R-IV-04 — close par le franchissement de G-1 (volet Livre I).** Les trois faits datés sont
  ...
  **15 mai 2025**, et le cadre d'autorisation de nouvelle génération **toujours à l'état de projet**
  ...
  ☑ **Revalidé à la source le 2 septembre 2026** ([rapport de revalidation](../PRD/revalidation-2026-09-02.md)), *la veille de l'échéance annoncée* :
  **l'expiration n'a pas eu lieu**, une révision neuve ayant été déposée avant le terme et repoussé
  celui-ci à **février 2027**. ⚠ **Le § 3.2.1 n'a toujours pas à être repris, et pour une raison
  plus forte qu'avant** : *ce qu'il présente est un projet, et **le renouvellement d'un brouillon
  ne le rapproche pas d'une norme** — il ne fait que reconduire son état.* **L'échéance surveillée
  n'était donc pas l'événement** : une expiration se repousse à volonté par son auteur ; ce qui
  changerait le statut est **l'adoption** ou **l'abandon**.
...
| **Volumétrie cible** | ≈ 9 000 mots de corps (§ 3.1 à § 3.4). Enveloppe **dérivée, non prescrite** ; ce chapitre pèse plus que la moyenne parce qu'il est **posé une seule fois pour cinq chapitres aval**. ☑ **Décompte publiable depuis le franchissement de G-2** (27 juillet 2026). **Réel : 5 734 mots — ⚠ *re-mesurés le **2 septembre 2026** ; l'en-tête portait **5 701**, soit **+33** : la mesure n'avait pas suivi les passes de relecture*** de corps, mesurés par [`PRD/decompte.sh`](../PRD/decompte.sh), seule autorité de décompte du volume — **−36,7 %** de la cible. ⚠ **Ce réel est re-mesuré au commit du 30 juillet 2026** (décision 16b) : *toute date de mesure antérieure citée dans ce champ décrit une passe précédente, et la passe de révision D-11 l'a périmée.* La mesure antérieure datait du commit de la seconde passe de relecture (5 104 mots et −43,3 % au terme de la première ; l'écart vient de six instruments repris nommés et de deux constructions d'auteur marquées). ⚠ **L'écart individuel ne se lit pas seul** : la somme des onze cibles dérivées atteint **93 000 mots** pour une enveloppe de Livre de **65 000** — chaque pièce a dérivé sa cible de l'enveloppe sans que personne n'additionne les dérivations. Le **réel du Livre était, au 27 juillet 2026, de 64 750 mots, soit −0,4 % de l'enveloppe** — ⚠ **cardinal de Livre à re-mesurer au terme de la passe de relecture**, les onze pièces étant révisées en parallèle : c'est la cible dérivée qui était fausse, non la pièce qui est courte. *Un écart se documente ; il ne se corrige ni par amputation ni par gonflement* |
