...
> ⚠ **ÉTAT : LE BARÈME A EST EXÉCUTÉ.** Les **115 candidats A** sont dessinés et posés dans leur pièce — voir `contenu*.py`, une entrée par figure. Le volume porte **118 figures** sur **1 000 pages** — *1 114 du 31 juillet au 9 août 2026, 1 072 au relevé ci-dessus ; le décompte de figures n'a pas bougé, seul le gabarit a été calé.* Les barèmes **B (94)** et **C (28)** restent ouverts, et ce document reste leur registre. ☑ **Les trois figures antérieures au programme sont entrées au graveur le 21 août 2026** — `f-01-00-invariant`, `f-01-01-pile-canonique`, `f-08-01-n-fois-m`, dessinées à la main avant `dessine.py`. ⚠ *Elles ne se regravent toujours pas, et ne le pourront pas* : aucune des huit primitives ne les rend, et les réexprimer produirait trois figures **différentes**. Ce que le registre `ANTERIEURES` de [`genere.py`](genere.py) ajoute est autre chose — il les **compte** et les **gèle à l'empreinte** : `genere.py --verifier` annonce désormais 118 figures et non 115, et sort 1 si l'une des trois disparaît, change d'un octet, ou cesse d'être appelée par sa pièce. ⚠ Ne pas relire les tableaux ci-dessous comme une liste de travaux à faire : la colonne de barème dit le rang, pas l'état.
