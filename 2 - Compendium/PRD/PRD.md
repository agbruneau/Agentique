...
**Ce qu'il ne fait pas.** Il ne spécifie pas le contenu des chapitres — le TOC v0.15 le fait, entrée par entrée, et chaque entrée du TOC **est** le cahier des charges de son chapitre : thèse, sections, ligne « Fusion » (provenance et arbitrages), socle assigné, garde-fous assignés, lacunes portées. Il ne fournit pas non plus de socle : la refonte (Annexe B du plan) est une porte de ce PRD, pas son contenu. Un §7 qui énumérerait des faits consolidés que personne n'a refondus serait la faute exacte que le Vol. III a nommée dans son propre PRD.
...
- **Vol. III — F-01…F-98 et H-01…H-33** : niveaux conservés (méthode héritée du Vol. II) ; les H-xx se dédupliquent contre les entrées Vol. I/II dont elles proviennent. **F-92 et F-96 du Vol. III n'entrent pas** avant résorption de leur dette de vote ou reprise de la parade ⚖ (TOC v0.15, Annexe B).
...
| **Volumétrie : condensation réelle ~52 % sur les Livres III/VII** (TOC v0.15, Volumétrie) | enveloppes intenables ou coupes de bornes | décision d'auteur D-4 (re-calibrage éventuel) ; l'écart se documente, ne s'ampute pas — *amputer une borne et couper un hors-périmètre produisent le même chiffre* (leçon du Vol. III) |
