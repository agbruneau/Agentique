...
**Ce qu'il ne fait pas.** Il ne spécifie pas le contenu des chapitres — le TOC v0.23 le fait, entrée par entrée — chaque entrée étant désormais suivie de sa table des matières détaillée, et chaque entrée du TOC **est** le cahier des charges de son chapitre : thèse, sections, ligne « Fusion » (provenance et arbitrages), socle assigné, garde-fous assignés, lacunes portées. Il ne fournit pas non plus de socle : la refonte (Annexe B du plan) est une porte de ce PRD, pas son contenu. Un §7 qui énumérerait des faits consolidés que personne n'a refondus serait la faute exacte que le Vol. III a nommée dans son propre PRD.
