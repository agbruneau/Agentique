...
| Statut | **Gouvernance posée, exécution non commencée.** Zéro pièce rédigée sur 61 (51 chapitres — les 57 entrées conservées en mouvements, décision 11 du TOC, plus le ch. 41 neuf, décision 12 —, avant-propos, 9 annexes) ; socle consolidé à **0 entrée** (la refonte est la porte G-3) ; sept portes de lancement, toutes ouvertes ; **huit** décisions d'auteur requises (Annexe A — D-8 ajoutée en v0.6 avec le ch. 41) |
| Livrable encadré | Compendium intégral — 51 chapitres en 5 livres (57 entrées conservées, décision 11 du TOC ; ch. 41 neuf, décision 12), avant-propos, 9 annexes ; ≈ 376 000–401 000 mots projetés (fourchette indicative, non normative — TOC, Volumétrie) |
...
- **O1.** Rédiger les 51 chapitres (57 entrées en mouvements, plus le ch. 41) et l'appareil en démontrant la thèse d'ensemble — un seul problème d'ingénierie continu sur quatre plans — sans diluer les thèses partielles absorbées (risque 6).
...
- **O4.** Constituer le **socle propre de la matière neuve** — premier mouvement du Livre V (ch. 47-49 — l'ancien Livre IX) **et ch. 41** (fabrique d'agents, v0.22) depuis des sources primaires, ou constater son échec et exécuter le retrait prévu (décision 9, risque 13).
- **O5.** Faire arbitrer et exécuter les **décisions d'auteur** que le TOC déclare hors de portée d'une passe (Annexe A de ce PRD).

### Non-objectifs

- Ne pas produire de thèse nouvelle hors de la matière neuve déclarée — premier mouvement du Livre V (ch. 47-49) et ch. 41 (Nature du TOC : une somme, pas un cinquième volume).
...
| **G-6** | **Sort de la matière neuve** — premier mouvement du Livre V (ch. 47-49 — l'ancien Livre IX) **et ch. 41** (v0.22, sous D-8) : socle propre constitué depuis des sources primaires, ou retrait (décision 9, issue prévue ; renumérotation inverse 49-50 → 46-47 assumée, décision 11) — décision d'auteur (D-3) | Premier mouvement du Livre V |
...
**Structure** : celle du TOC v0.22 — 51 chapitres en cinq livres (condensation v0.20, décision 11 ; insertion du ch. 41, décision 12), carte des 57 entrées inchangée de la v0.14 à la v0.19 puis conservée en mouvements —, sans reprise ici. Chaque pièce porte en tête le tableau à cinq champs hérité (Statut ; Date de gel ; Socle mobilisé — **chaque identifiant préfixé de son volume d'origine tant que la renumérotation G-3 n'est pas publiée** ; Garde-fous balayés — **y compris ceux à zéro occurrence**, contrepartie obligatoire des onze pièces de synthèse (ch. 42, 43, 46, 50 et 51, plus les six annexes de méthode ou de table ; ⚠ **le ch. 41 n'en est pas une** — il n'est pas un chapitre de synthèse mais de matière neuve, et relève du régime de preuve le plus dur) ; Volumétrie cible), suivi de la thèse citée depuis le TOC.
...
5. **Premier mouvement du Livre V** (ch. 47-49) — dernière matière rédigée (décision 9c), après G-5 et G-6.
6. **Second mouvement du Livre V** (ch. 50-51) — la clôture ferme l'ouvrage : le ch. 50 enregistre l'état final des lacunes, le ch. 51 le registre de gel par chapitre.
...
| Matière neuve | premier mouvement du V (ch. 47-49) **et ch. 41** | **toutes les affirmations centrales** — le régime le plus dur, pour la matière la plus nue | sources primaires seules ; échec documenté = résultat (retrait, G-6) |
...
- **CA-IV-06 Honnêteté des lacunes.** Toutes les lacunes du registre (§10) apparaissent, aucune silencieusement omise ; le ch. 50 les reprend une à une par identifiant.
- **CA-IV-07 Marquage des inférences.** Toute construction d'auteur porte « Lecture de l'auteur », suivi de ce que le socle établit et n'établit pas ; les chapitres de matière neuve (ch. 47-49 et ch. 41) le portent à l'ouverture ; les passages du Vol. III issus des réaffectations P0.2 conservent leur marquage CA-07 d'origine.
...
| **J-IV-7** | Premier mouvement du Livre V (ch. 47-49) — ou son retrait | socle propre publié et voté, ou retrait exécuté (renumérotation inverse, journaux) |
| **J-IV-8** | Second mouvement du Livre V (ch. 50-51) + appareil complet | registre des lacunes intégral au ch. 50 ; registre de gel au ch. 51 ; 9 annexes livrées |
...
**Définition de « terminé »** : les 61 pièces rédigées, relues adversarialement et tracées ; grille CA-IV conforme par constatation ; lacunes toutes exposées ; décomptes re-mesurés et concordants entre porteurs ; le statut du TOC (« les volumes font foi ») retourné.
...
| **D-3** | **Premier mouvement du Livre V** (ch. 47-49) : constitution du socle ou retrait | avant J-IV-7 | ☐ |
...
| **D-7** | **Risque 15** (l'accord entre agents sous défaillance) : sections dans les chapitres d'atterrissage (ch. 6, 37, 49), ou périmètre assumé et déclaré. ⚠ **Sans porte dédiée** — à la différence du risque 14 (G-5), ce constat ne conditionne aucun livre entier ; il conditionne le ch. 6, donc la rédaction du Livre I | avant J-IV-4 | ☐ |
