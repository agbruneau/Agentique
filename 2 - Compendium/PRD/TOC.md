...
| Date                                        | 27 juillet 2026 (révision de finalisation post-condensation)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Nature                                      | **Compendium intégral** : omnibus qui absorbe Vol. I, II et III en un seul ouvrage réordonné, dédoublonné, à lecture autonome. Ce n'est ni un panneau du triptyque ni un méta-index — c'est la *somme* qui les remplace. ⚠ **Depuis la v0.8, l'absorption ne couvre plus tout l'ouvrage** : le **premier mouvement du Livre V** — les ch. 46-48, l'agent comme livrable logiciel (Livre XII à son entrée en v0.8 ; Livre IX de la v0.9 à la v0.19) — est de la matière neuve sans volume source, admise sur décision d'auteur et déclarée telle (décision 9, risque 13)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
**Ajout v0.8 — le quatrième plan.** Les trois plans tiennent l'agent pour un *interlocuteur* : à faire coopérer, à encadrer, à accréditer. Or il est aussi un *livrable logiciel* — un artefact qui se compose, se met en service et produit des effets — et l'audit v0.3 a établi qu'aucun des trois volumes ne le traite ainsi. Le **premier mouvement du Livre V** — ch. 46-48, entré en v0.8 comme Livre XII, Livre IX de la v0.9 à la v0.19 —, matière neuve admise sur décision d'auteur (décision 9), porte ce quatrième plan : provenance des composants, mise en service, sémantique d'effet. Il **complète** la démonstration de continuité, il ne la fonde pas — et il est le seul ensemble de chapitres de la somme sans socle hérité, ce qui se déclare (risque 13).
...
| §2.13.1 | ch. 42 | hors périmètre (grille « quand agentifier ») |
...
*Fusion : Vol. III ch. 4 (chapitre de méthode transversal, homologue de la matrice du ch. 41).*
...
Sections : recension (identifiants de vulnérabilité, incidents datés — dont les divulgations du 1ᵉʳ semestre 2026 relevées en v0.7, corpus candidat du dénombrement exigé par la décision 8, à qualifier pièce par pièce avant usage —, littérature ; ⚠ **relève v0.10** : une classe dont le vecteur est le **harnais** — extension tierce admise par simple configuration — et non le protocole ni le mécanisme d'identité (voir ch. 46) ; si elle s'instruit, elle entre au dénombrement **contre** la thèse d'absorption de ce chapitre, non à son appui) ; taxonomie par la grille du ch. 14 ; empoisonnement de la mémoire et des sources (provenance RAG comme problème d'identité des sources — reprend le ch. 5) ; ce que la recension ne trouve pas.
...
⚠ **Relève v0.10** : une classe d'attaques dont le vecteur est le **harnais** (extension tierce admise par simple configuration), et non le protocole ni le mécanisme d'identité — voir ch. 46. Si elle s'instruit, elle entre au dénombrement **contre** la thèse d'absorption de ce chapitre, non à son appui.
...
*Fusion : Vol. III ch. 13-14. Renvoi ch. 39 (dérive en exploitation) et ch. 44 (révocation dans le cycle de vie). ⚠ **Relève v0.10** : le rug-pull a un grain de plus fin que le serveur d'outils — l'**extension déclarative** du harnais (fichier d'instructions, serveur ajouté par configuration), dont l'installation n'est pas un acte de compilation et dont la révocation n'a, à cette date, aucun mécanisme relevé. À instruire à la source primaire ; l'incident public candidat est décrit au ch. 46.*
...
⚠ **Relève v0.10, à instruire** : le *rug-pull* a un grain plus fin que le serveur d'outils — l'**extension déclarative** du harnais (fichier d'instructions, serveur ajouté par configuration), dont l'installation n'est pas un acte de compilation et dont la révocation n'a, à cette date, **aucun mécanisme relevé**. Incident public candidat décrit au ch. 46.
...
*← Vol. III* Monographie *§14.3 ; **problème ouvert**, adossé au ch. 17 ; renvoi ch. 44 (révocation dans le cycle de vie).*
...
*(fusionne Vol. II Partie II **hors ch. 8** — scindé au Livre II — + Vol. I ch. 4 **hors §4.8, §4.9 et §4.12** — partis au présent livre et au Livre IV — + §1.6.3/§2.8.4 ; + Vol. II Partie III + Vol. III Partie VI + Vol. I §4.8/§5.3 ; + Vol. II Parties IV-V + Vol. I ch. 5 **hors §5.0, §5.3, §5.5.4 et §5.12.1-5.12.3** — partis à l'avant-propos et aux ch. 30, ch. 18 et ch. 42 ; condensation v0.20 : absorbe les anciens Livres IV, V et VI, décision 11 ; trois mouvements — l'autonomie encadrée, ch. 22-24 ; le cadre réglementaire canadien, ch. 25-30 ; le terrain canadien, ch. 31-36 ; ~90 000 mots)*
...
*← Vol. II §15.4 ; le substrat sémantique est au ch. 31 § 31.2, le flux instancié au ch. 44.*
...
*Fusion : Vol. I* Monographie *§5.7-5.11 + §5.12.4-5.12.7 + §5.14 (synthèse de chapitre — **rattachement corrigé en v0.3** : le §5.14 est la clôture du ch. 5, non un développement sur les paiements agentiques). Les §5.12.1-5.12.3 (architecture de référence, maturité, grille de décision) sont consolidés au ch. 42 ; le §5.13 (interop B2B, commerce et paiements agentiques) au ch. 36.*
...
| §5.12.1-5.12.3 | ch. 42 | hors périmètre (architecture, maturité, grille) |
...
## LIVRE IV — Appliquer, exploiter et composer : AgentMesh, AgentOps et synthèse architecturale

*(fusionne Vol. III Parties VII-VIII + Vol. I §1.3.4 + §2.9.6/§2.11.1/§2.11.4-2.11.5/§4.9 — condensation v0.9 : absorbe l'ancien Livre X, décision 10 ; + Vol. I ch. 6 + Annexe B ADS + Vol. II Partie VI **hors ch. 21** + ch. 22-23 — le ch. 21 et le ch. 24 du Vol. II vont au Livre V — + Vol. III Partie IX ; condensation v0.20 : absorbe les anciens Livres VII et VIII, décision 11 ; trois mouvements — appliquer, ch. 37 ; exploiter, ch. 38-40 ; composer, ch. 41-45 ; ~62 000 mots)*
...
*← Vol. III* Monographie *§23.1 (langages de politique, état des mécanismes).* Le maillage est **le lieu où le passeport du ch. 16 devient opposable**.
...
⚠ *Prolonge les **points de contrôle obligatoires** (Vol. II ch. 19 §19.3, repris au ch. 42) au grain de l'infrastructure.*
...
*← Vol. III* Monographie *§25.4 + Vol. I* Monographie *§2.11.5 (AIOps agentique) ; le grain du déploiement est au ch. 47.*
...
*← Vol. III* Monographie *§26.2 : disponibilité du parc, couverture de traçabilité, délai de révocation, fraîcheur des évaluations.* ⚠ **Construction d'auteur**, dérivée des obligations des Livres III-IV — marquée telle.
...
**Second mouvement — synthèse architecturale et blueprint (ch. 41-45)** *(ancien Livre VIII)*

### Chapitre 41 — La matrice protocoles × exigences réglementaires
...
#### § 41.1 — Construction de la matrice
...
#### § 41.2 — Lecture par protocole

*← Vol. II §18.2.*

#### § 41.3 — Lecture par exigence

*← Vol. II §18.3.*

#### § 41.4 — Les zones de compensation architecturale
...
| Source | Destination | Régime |
| --- | --- | --- |
| Vol. II §18.1-18.4 | § 41.1-41.4 | condensé |
| Vol. II *Monographie* Annexe B | § 41.1 | source des quinze croisements |
| Vol. III Annexe B | § 41.1 | matrice des mécanismes |

### Chapitre 42 — L'architecture de référence unifiée par couches
...
*Fusion : Vol. II ch. 19 + Vol. III ch. 27 §27.1/§27.4 + Vol. I* Monographie *§5.12.1-5.12.3, §6.10 (maturité et feuille de route par plateaux — **prélevé au ch. 6 du Vol. I, que le ch. 43 traite par ailleurs en bloc**), §4.12 (plan de contrôle d'agents) et §2.13.1 (grille « quand agentifier »). Socle : F-36, F-37, F-46 + Livre III.*
...
#### § 42.1 — Les couches et leurs responsabilités
...
#### § 42.2 — Le positionnement des options d'orchestration par cas d'usage
...
#### § 42.3 — Les points de contrôle obligatoires

*← Vol. II §19.3 ; prolongés au grain de l'infrastructure au ch. 37.*

#### § 42.4 — Le plan de contrôle d'agents comme architecture de référence
...
#### § 42.5 — Le modèle de maturité de l'entreprise agentique

*← Vol. III* Monographie *§27.4 + Vol. I* Monographie *§5.12.2 et §6.10 (maturité et feuille de route par plateaux — **prélevé au ch. 6 du Vol. I, que le ch. 43 traite par ailleurs en bloc**).*
...
#### § 42.6 — Alternatives, variantes et frontières d'abstraction
...
| Source | Destination | Régime |
| --- | --- | --- |
| Vol. II §19.1-19.4 | § 42.1-42.3, § 42.6 | condensé |
| Vol. III *Monographie* §27.1, §27.4 | § 42.1, § 42.5 | condensé ; §27.2 au ch. 43, §27.3/§27.5 au ch. 44 |
| Vol. I *Monographie* §5.12.1-5.12.3 | § 42.4-42.6 | **arrivée** depuis le ch. 34 |
| Vol. I *Monographie* §6.10 | § 42.5 | **prélevé au ch. 43** |
| Vol. I *Monographie* §4.12 | § 42.4 | **arrivée** depuis le ch. 24 |
| Vol. I *Monographie* §2.13.1 | § 42.2 | **arrivée** depuis le ch. 6 |

### Chapitre 43 — La formalisation ArchiMate
...
#### § 43.0 — Primer ArchiMate et convention de version
...
#### § 43.1 — Le problème de modélisation : patrons pour concepts agentiques
...
- 43.1.9 **Registre des stéréotypes du blueprint** — *← §6.1.9.* ⚠ **Point d'appui aval dont dépendent les ch. 44 et l'Annexe H : il se tient ici, en un seul lieu.**

#### § 43.2 — Motivation : exigences réglementaires traçables
...
#### § 43.3 — Strategy : capacités agentiques et chaînes de valeur financières

*← §6.3.1-6.3.4.*

#### § 43.4 — Business : rôles, collaborations humain-agent et objets financiers

*← §6.4.1-6.4.5.*

#### § 43.5 — Application et Technology : agents, protocoles, runtime, résidence

*← §6.5.x.*

#### § 43.6 — Points de vue transverses
...
#### § 43.7 — Gouvernance des vues et organisation du blueprint

*← §6.7.1-6.7.4.*

#### § 43.8 — Bibliothèque de patrons et anti-patrons

*← §6.9.1-6.9.2.*

#### § 43.9 — Questions ouvertes : ArchiMate face aux systèmes autonomes
...
| Source Vol. I *Monographie* | Destination | Régime |
| --- | --- | --- |
| §6.0 | § 43.0 | condensé ; §6.0.1 refondu en apparat |
| §6.1-6.7 | § 43.1-43.7 | condensé |
| §6.8 | **ch. 44** | prélevé (exemple de bout en bout) |
| §6.9 | § 43.8 | condensé |
| §6.10 | **ch. 42** | prélevé (maturité par plateaux) |
| §6.11 | § 43.9 | condensé |
| Vol. III *Monographie* §27.2 | § 43 (transverse) | formalisation seule |

### Chapitre 44 — Le blueprint instancié et son cycle de vie : de Boréalis au portefeuille IBM, puis la naissance, la vie et la mort d'un agent d'entreprise
...
#### § 44.5 — Points d'intégration avec l'existant : étendre, ne pas dupliquer

*← Vol. III* Monographie *§27.3 ; IAM et observabilité en place (Livres II et IV).*

#### § 44.6 — L'organisation de la fabrique : qui opère quoi
...
#### § 44.8 — Naissance : enregistrement, émission du passeport, admission au maillage

*← Vol. III* Monographie *§28.1 ; ch. 15-16 et ch. 37 joués contre l'architecture.*

#### § 44.9 — Vie : délégations, vérifications par arête, traces, évaluations continues, renouvellements, migration post-quantique

*← Vol. III* Monographie *§28.2 ; ch. 17, 37, 38, 39 et 21.*

#### § 44.10 — Mort : révocation, cascade dans la chaîne de mandat, retrait du maillage, archivage probatoire

*← Vol. III* Monographie *§28.3 ; la révocation en cascade reste un **problème ouvert** (ch. 20 § 20.6).*

#### § 44.11 — Flux 1 — la décision de crédit assistée par agents : le processus commande, OO3 ou OO4
...
#### § 44.12 — Flux 2 — le paiement ISO 20022 vers Lynx : l'agent observe, le rail exécute

*← Vol. II §23.3 ; ch. 33.*

#### § 44.13 — Flux 3 — l'accès au cadre bancaire : concevoir contre une norme qui n'existe pas encore

*← Vol. II §23.4 ; ch. 32 (standard technique non désigné, fait négatif vérifié).*

#### § 44.14 — Exemple de bout en bout : souscription vie augmentée (et variante FNOL P&C)
...
| Source | Destination | Régime |
| --- | --- | --- |
| Vol. III *Monographie* §28.1-28.4 | § 44.8-44.10, § 44.15 | condensé |
| Vol. III *Monographie* §28.5 | ch. 49 | prélevé (questions transmises) |
| Vol. III *Monographie* §28.6 | ch. 50 | prélevé (péremption) |
| Vol. II §23.2-23.4 | § 44.11-44.13 | condensé ; §23.1 au ch. 44 |
| Vol. I *Monographie* §6.8 | § 44.14 | **prélevé au ch. 43** |

### Chapitre 45 — Instrumentation et feuille de route vers le 1ᵉʳ mai 2027
...
#### § 45.1 — Des métriques académiques aux indicateurs de risque de modèle
...
#### § 45.2 — Feuille de route type : inventaire, encadrement, surveillance

*← Vol. II §20.2 ; séquencée sur l'entrée en vigueur commune du 1ᵉʳ mai 2027 (ch. 25 et ch. 27).*

#### § 45.3 — Les jalons externes à surveiller
...
| Source | Destination | Régime |
| --- | --- | --- |
| Vol. II §20.1-20.3 | § 45.1-45.3 | condensé |

---

## LIVRE V — Livrer et clore : l'agent comme livrable logiciel, horizon et frontière

*(matière neuve — aucun volume source pour les ch. 46-48 ; réouverture v0.8 de la décision de périmètre v0.3, sur instruction d'auteur du 20 juillet 2026 ; + fusionne Vol. I ch. 7 + §3.13.2-3.13.4 + Vol. II ch. 21/24 + Vol. III clôture ; condensation v0.20 : absorbe les anciens Livres IX et X, décision 11 ; deux mouvements — l'agent comme livrable logiciel, ch. 46-48 ; horizon et clôture, ch. 49-50 ; ~34 000 mots)*

**Premier mouvement — l'agent comme livrable logiciel : provenance, mise en service, sémantique d'effet (ch. 46-48)** *(ancien Livre IX)*
...
### Chapitre 46 — La provenance des composants : de quoi un agent est fait
...
#### § 46.2 — Nomenclatures logicielles et d'IA : état des normes et de l'outillage

*sources primaires à constituer.*

#### § 46.3 — Signature et attestation d'artefacts

modèles, serveurs d'outils, invites ; adossement ch. 20 § 20.3 (attestation d'intégrité à l'exécution), sans le reconstruire.

#### § 46.4 — Le *rug-pull* du ch. 20 relu comme défaut de provenance

adossement ch. 20 § 20.1.

#### § 46.5 — La provenance comme pièce candidate du passeport du ch. 16
...
#### § 46.6 — Les divulgations de chaîne d'approvisionnement du 1ᵉʳ semestre 2026

*relève 7 de la v0.7 : **candidates, à instruire à sources primaires**.*

#### § 46.7 — ⚠ Relève v0.10 : l'extension déclarative, composant que la nomenclature ne voit pas
...
### Chapitre 47 — La mise en service d'un artefact non reproductible
...
#### § 47.1 — Le versionnement à quatre horloges
...
#### § 47.2 — Jeux d'essai de référence et barrière d'évaluation au déploiement

ponts : évaluation du ch. 6 (fondements), évaluation continue du ch. 39 § 39.1.

#### § 47.3 — Promotion par environnements et GitOps du parc

le ch. 39 § 39.4 **au grain du déploiement**, sans le reconstruire ; pré-production gouvernée au ch. 40 § 40.6.

#### § 47.4 — Retour arrière d'un artefact à état
...
ponts : flux ISO 20022 des ch. 33 et ch. 44 § 44.12 ; le trou de responsabilité du ch. 36 § 36.2.6.
...
| Appui | Nature |
| --- | --- |
| ch. 1, ch. 22, ch. 33, ch. 38, ch. 44 | **adossements internes** — renvois, jamais sources |
...
*← Vol. II §21.1 ; **les onze du PRD Vol. II reprises une à une, par leur identifiant** (registre à l'Annexe C) :* §10.1 (organisme de normalisation, ch. 30), §10.2 (institutions sans socle complet, ch. 35), §10.3 (frameworks, ch. 23), §10.4 (**contenu de la ligne AMF — la plus coûteuse**, ch. 27), §10.5 (AP2 ↔ rails canadiens, ch. 36), §10.6 (portefeuille IBM, ch. 44), §10.7 (**composante ACP d'AGNTCY, quatrième branche de R-8**, ch. 7), §10.8 (**aucune attaque documentée propre à A2A**, ch. 11 et ch. 19), §10.9 (anatomie et gouvernance d'AP2, ch. 8 et ch. 10), §10.10 (sous-caractérisation de F-36 et F-37, ch. 22), §10.11 (datation du Budget 2025, ch. 32).
...
*← Vol. II §24.1 ; renvoi ch. 44 (lacune PRD Vol. II §10.6).*
...
- **Annexe C — Faits partagés, divergences tranchées et lacunes ouvertes** *(⚠ **réouverture d'une décision prise**, non résorption d'un fichier pendant : le Vol. III a décidé de **ne pas** créer `commun/faits-partages.md`, ses divergences vivant au PRD §7.5 — décision qu'il autorise expressément le Vol. IV à rouvrir s'il entre en rédaction. C'est ce que fait cette annexe, et il faut l'écrire ainsi)* : source unique des faits datés cités par plusieurs livres, et **résolution des deux divergences héritées** — (1) date de finalisation de la ligne directrice IA de l'AMF : **30 mars 2026** (position du Vol. II, la plus récente) ; (2) gouvernance d'AP2 : **aucun transfert documenté** à date de gel. Toute réouverture exige une source primaire nouvelle datée. ⚠ **Réouverture déclenchée en v0.7** : le don d'AP2 à la FIDO Alliance (annoncé au 28 avril 2026, deux groupes de travail — voir ch. 10) est le fait nouveau candidat ; la divergence ne se re-tranche qu'après extraction de la source primaire, et le socle du Vol. II, gelé, n'est **pas** corrigé rétroactivement — si le fait se confirme, il s'écrit comme un fait **postérieur à l'instruction du Vol. II**, ou antérieur mais non capté par elle, ce qui se dit et ne se lisse pas. ⚠ **Une divergence tranchée n'est pas une lacune comblée** : l'annexe tient un **registre distinct des absences héritées**, avec la règle du Vol. II en toutes lettres — *aucune de ces absences n'établit un fait négatif*. Trois entrées seulement sont des faits négatifs vérifiés par balayage documenté (F-09, F-35, F-46).
  ...
  | §10.6               | Portefeuille IBM — Gartner MQ iPaaS (R-6), FTM/ISO 20022 [C], annonces canadiennes                                          | ch. 44, ch. 50                         |
...
- **Annexe F — Matrice des mécanismes** : les mécanismes des Livres I-II et les composants de maillage/exploitation (Livre IV) croisés avec la grille des cinq questions, l'état PQC et la couverture d'observabilité — la table de référence de l'ouvrage. *Fusion : **Vol. III Annexe B**, dont cette annexe est le prolongement. ⚠ **Partage à tenir** : le ch. 41 en tire la lecture croisée protocoles × exigences réglementaires ; l'annexe porte la table complète. La v0.2 les revendiquait toutes deux sans arbitrer — une matrice recopiée en deux endroits diverge à la première correction.*
...
- **Annexe H — ADS Boréalis** *(**20 655 mots mesurés**, 19 juill. 2026 — et non les « ≈ 90 000 » que portaient les v0.1-v0.4)* : l'architecture détaillée de solution du Vol. I (Annexe B de sa Monographie), conservée intégralement comme instanciation de référence du blueprint (ch. 44) — inventaire produit, matrice de traçabilité, catalogue de diagrammes, configurations illustratives. Nature distincte du corps doctrinal : livrable d'ingénierie *prêt au déploiement*, dont l'insight directeur (plan de contrôle obligatoire + dorsale d'intégration tri-plan non interchangeable) et le revers assumé (*vendor lock-in*, dépendance à un tiers TIC critique, tranché en ADR-001) sont repris tels quels.
  ⚠ **Trois collisions de numérotation, dont deux que la fusion crée elle-même — décision 7 étendue, ajout de la v0.5.** Le Vol. I déclare un « piège de numérotation à ne jamais confondre » à trois branches ; en devenant l'Annexe H d'un ouvrage à 50 chapitres et 9 annexes, ce piège **change de forme et s'aggrave**, et aucune des v0.1-v0.4 ne le traitait. (a) L'ADS porte sa propre numérotation **§0-§17**, qui coexiste désormais avec les §N.x des chapitres de la somme : tout renvoi vers elle s'écrit `Annexe H §N`, jamais `§N` nu. (b) L'ADS porte ses **propres sous-annexes A-F**, dont une « Annexe B » (matrice de traçabilité) qui **entre en collision frontale avec l'Annexe B de la somme** (socle factuel consolidé) — collision nouvelle, absente du Vol. I où l'Annexe B *était* l'ADS : les sous-annexes de l'ADS s'écrivent `Annexe H, sous-annexe B`. (c) Les renvois **internes** de l'ADS vers le corps doctrinal sont explicites et **tous périmés par la fusion** : ils sont de la forme `cf. Monographie ch.6 §6.1.3` et visent le chapitre ArchiMate du Vol. I, devenu le **ch. 43** de la somme — le rebasage de ces renvois est une tâche de fusion à part entière, à mener avec la refonte du socle (Annexe B) et non après. *Conventions propres reconduites : diagrammes **Mermaid inline** légendés, devant passer `mmdc` ; vues en **ArchiMate 4**, équivalent 3.2 noté si requis (ancrage au ch. 43) ; extraits de configuration illustratifs, jamais de secret réel ; valeurs chiffrées (SLO, RPO/RTO, débits) = hypothèses à calibrer.*
...
1. **Explosion volumétrique et non-lecture** *(aggravé en v0.5 : la re-mesure porte la projection de 300 000-326 000 à **355 000-380 000 mots**, non par ajout de contenu mais par correction d'un budget d'annexes sous-évalué de moitié ; re-aggravé en v0.8 : l'ajout du Livre XII (aujourd'hui premier mouvement du Livre V) — 14 000 mots de matière neuve — porte la projection à **369 000-394 000 mots**, cette fois par ajout de contenu, assumé en décision 9)* : une somme de cette taille est un ouvrage de référence, pas un ouvrage de lecture linéaire. Parade obligatoire : parcours différenciés annoncés (les « contrats de lecture » des trois volumes conservés), renvois internes denses, et l'Annexe F comme table de navigation. Sans cela, le compendium est moins utile que les trois volumes séparés — ce qui invaliderait sa raison d'être.
2. **Déduplication infidèle** : fusionner deux traitements d'un même sujet (ex. identité au ch. 3 vs Livre II ; blueprint Boréalis vs IBM au ch. 44) risque d'effacer une nuance que la séparation préservait. Parade : la ligne « Fusion » de chaque chapitre trace la décision ; toute coupe de contenu est un acte documenté, pas un silence.
...
6. **Perte de la thèse dans la masse** : trois thèses partielles fondues risquent de diluer la thèse unifiante (le problème d'ingénierie continu). Parade : chaque livre rappelle en ouverture sa place dans les trois plans (coopérer / encadrer / faire confiance — auxquels la v0.8 adjoint un quatrième, *livrer*, porté par les seuls ch. 46-48 (Livre V) et muni de son critère d'exclusion propre en tête de mouvement) ; tout contenu sans rattachement à l'un de ces plans est hors périmètre.
