...
## Journal v0.29 — la passe d'audit (28 juillet 2026)

**Objet.** Solder les huit remontées de l'**audit intégral des cinq Livres** du 28 juillet 2026
(`audit.md` — cent constats sur le corpus du commit `8cb40fa`, **un seul bloquant**),
...
- **Décision 16 — ce qu'un décompte d'occurrences compte.** Le constat le plus répandu de l'audit :
...
- **Décision 17 — une thèse réalignée se reporte à la pièce, au même commit.** Corollaire des
  ...
  périmètre entière** — seul constat bloquant de l'audit, et classe exacte de R-IV-83 et R-IV-87.
