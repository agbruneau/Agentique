...
| Date                                        | 27 juillet 2026 (arbitrage du Livre V : seize remontées soldées, trois thèses réalignées, D-2 et D-3 prises, deux sièges versés ; aucune porte franchie par cette passe)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
**Thèse** : le maillage est le lieu où le passeport du ch. 16 devient opposable — PEP adossé à un PDP, transposition du zero trust au graphe d'agents : vérifier chaque arête, sans confiance héritée de la topologie.
...
**Thèse** : la discipline naissante n'a pas ses indicateurs de référence ; les métriques publiées sont hétérogènes et auto-déclarées — grille minimale dérivée des obligations des Livres III-IV, présentée comme construction d'auteur ; le modèle de coût agentique est une contrainte d'ingénierie de premier ordre.
...
| bibliographie du Vol. I (*Monographie* §7.10.4, série *Agent Factory* de Microsoft) | **fait de dépôt relevé sur pièce** le 27 juillet 2026 — atteste l'**emploi du terme par un éditeur**, rien de plus ; n'entre pas au socle |
...
**Thèse** : les Livres I-IV se composent en une architecture cible neutre à couches (protocoles, identité/registre, orchestration, maillage, exploitation, gouvernance), structurée par OO1-OO4, avec OO3/OO4 et la fabrique d'identité imposés sous exigence réglementaire stricte.
...
- 43.1.1 Le verrou méthodologique : **aucun élément natif**, le recours à la spécialisation — *← §6.1.1*
- 43.1.2 Patron « agent » : Application Component vs Role vs Collaboration — *← §6.1.2*
- 43.1.3 Patron « appel d'outil MCP » : Application Service + Interface + Serving — *← §6.1.3*
- 43.1.4 Patron « interaction A2A » : Collaboration + Flow + Triggering — *← §6.1.4*
- 43.1.5 Patron « identité non humaine » : Role + Active Structure + overlay sécurité — *← §6.1.5*
- 43.1.6 Patron « plan de contrôle d'agents » et limite « découverte dynamique » — *← §6.1.6*
- 43.1.7 Patron « humain-agent » : HITL, *four-eyes*, autonomie graduée — *← §6.1.7*
- 43.1.8 Patron « mémoire, RAG et *grounding* gouverné » — *← §6.1.8*
- 43.1.9 **Registre des stéréotypes du blueprint** — *← §6.1.9.* ⚠ **Point d'appui aval dont dépendent les ch. 45 et l'Annexe H : il se tient ici, en un seul lieu.**
...
| §6.11 | § 44.9 | condensé |
| Vol. III *Monographie* §27.2 | § 43 (transverse) | formalisation seule |
