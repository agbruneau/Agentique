...
| Vol. III *Monographie* §4.3, sièges d'application §12.2 et §19.1 | **ch. 25 § 25.1** et **ch. 37 § 37.4** | **arrivées déclarées — ajout v0.25** (remontée **R-IV-21**) : le § 14.3 nomme ces deux sièges d'après la table de correspondance du plan, **jamais d'après un texte** ; les deux chapitres cibles ne sont pas rédigés |
...
**Table des matières détaillée du chapitre 41** *(⚠ **chapitre neuf, sans ancien numéro** : partout ailleurs dans ce fichier, l'en-tête « Table des matières détaillée du chapitre N » cite la numérotation **antérieure à la v0.20** — celle-ci cite la numérotation **courante**, faute d'ancien numéro à citer. Ne pas « harmoniser » l'une sur l'autre.)*
...
*⚠ **Garde-fou de non-redondance, hérité du Vol. I §6.0.1 et plus nécessaire ici qu'à sa source** : « si l'on retire le mot ArchiMate et que la phrase tient encore comme un exposé des chapitres amont, c'est une redondance à renvoyer ». Au Vol. I, ce chapitre en suivait cinq ; ici il en suit quarante-deux.*
