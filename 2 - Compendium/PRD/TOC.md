...
⚠ **Le volume s'est appelé « La somme agentique » du 23 juillet au 8 août 2026, et il faut le savoir pour lire le dépôt.** Ce titre-là revendiquait le **genre** — une *summa*, non une anthologie. Le renommage du 8 août 2026 (décision 20) lui substitue un titre qui nomme l'**objet**. ⚠ **Deux conséquences, écrites plutôt que tues.** *(a)* **La veille technologique EST rattrapée, sur instruction d'auteur du 8 août 2026, et c'est une exception nommée à la règle du dépôt** : ses références **[220]** et **[266]** et son tableau des régimes portent le titre neuf, chacune assortie de la mention que le volume s'appelait autrement à la date de consultation. *La règle — « une revue publiée décrit l'état de ses sources à sa date » — n'est pas abrogée ; elle est écartée pour ce seul objet, parce qu'un titre n'est pas un fait daté mais un identifiant, et qu'un identifiant périmé ne résout plus.* *(b)* ⚠ **Le nouveau titre est à un mot près celui de la veille elle-même** (« Interopérabilité et orchestration agentique en entreprise ») : les deux documents du dépôt se distinguent désormais par leur **numéro de volume et leur genre**, non par leur intitulé — *un lecteur qui cite « Interopérabilité et orchestration agentique en entreprise » sans dire lequel des deux ne désigne rien.*
