...
opposabilité**. **Trois conséquences pour ce Livre.** *(1)* **Ses quinze chapitres sont arrêtés dans leur
...
`2 - Compendium/`) et se déclare. *(2)* ⚠ **Rien de ce qui suit n'est levé, et l'infraction à D-9 le
moins de tout** : les **ch. 25 et 27** ont été rédigés alors que le lot d'instruction du § 17.5 était
ouvert et bloquant pour eux deux, *et un arbitrage qui suit une infraction la solde sans la rattraper* ;
**G-1 résiduel, G-4 fond, G-5 balayage et G-6 lots sont clos POUR CE SEUL RÉGIME par dérogation nommée**,
leur résidu entier — *la dérogation tombe à la première diffusion et rouvre tout ce qu'elle couvrait*.
...
Le Livre III compte **quinze chapitres** au plan (ch. 22-36), en **trois mouvements** — l'autonomie
encadrée (ch. 22-24), le cadre réglementaire canadien (ch. 25-30), le terrain canadien (ch. 31-36).
**Les quinze sont rédigés** ; ils l'ont été **hors portes**, et ils restent en **brouillon non
publiable**.

| | État au terme de la passe d'arbitrage |
|---|---|
| **Remontées ouvertes** | **zéro** — R-IV-76 à R-IV-99 closes, chacune là où elle fait foi |
| **Décisions d'auteur prises** | **cinq sur neuf** — inchangé : D-1, D-4, D-6, D-7, D-9. ⚠ **Aucune décision neuve** : *les vingt-quatre remontées se sont soldées par des règles que le plan porte déjà* |
| **Thèses réalignées** | **deux sur quinze** — ch. 25 et ch. 27 (décisions 8 et 14 du TOC) |
| **Portes franchies** | **deux sur sept** — inchangé : **G-2** entièrement ; **G-1 pour le seul volet du Livre I**, dont ce Livre ne bénéficie pas |
| **Volet résiduel de G-1** | ⚠ **dû** — *une seule instruction bénéficie à ce Livre, et elle vient du volet Livre I* : la **divergence de gouvernance du protocole de paiement agentique**, consommée par extraction (ch. 36 § 36.1) |
| **Porte G-4** | ⚠ **volet structurel levé, volet de fond dû** — *elle conditionne **trois chapitres** de ce Livre : ch. 25, 27 et 30* |
...
1. ⚠ **La décision d'auteur D-9 est enfreinte nommément, deux fois.** Le PRD v0.9 écrit que **« les
   ch. 25 et 27 ne se lancent pas avant clôture du lot [d'instruction du § 17.5] »**, au titre de la
   règle d'escalade. **Le lot est ouvert et non clos.** Les deux chapitres ont été rédigés sur
   **instruction d'auteur du 27 juillet 2026**, et **ils prescrivent l'un et l'autre la parade humaine
   dont ce lot est la limite empirique** — *l'art. 12.1 au ch. 27 § 27.3, la surveillance continue
   attendue par E-23 au ch. 25 § 25.6*. ⚠ ***L'infraction est consignée à chaque pièce et n'est pas
   effacée par l'arbitrage qui la suit*** — c'est le régime que D-7 a appliqué au ch. 6 du Livre I.
2. ⚠ **La porte G-4 conditionne trois chapitres et n'est pas franchie.** Le PRD §5 écrit qu'elle
   conditionne « **toute entrée citant le Vol. III** » : les **ch. 25, 27 et 30** en proviennent pour
   sept sections. *Son volet structurel est levé ; **son volet de fond reste entier**.*

⚠ **Ce qui n'est PAS enfreint, et qui distingue ce Livre du Livre II.** L'**ordre de rédaction du
PRD §6** est respecté : *il place les **Livres I et III en première position**, et le Livre I était
...
ici** : **CA-IV-11 et CA-IV-13 exigent un relecteur distinct du rédacteur**, que **D-6 ne fournit
...
du TOC) : *les deux entrées y sont conservées intégralement, avec leurs deux thèses, et **la rédaction
ne les fond pas en une troisième**.* ⚠ **Deux autres sont « conservés intacts » au plan** — les
**ch. 29 et 35** : *leur structure source est reprise **sans redécoupage**.*

## Six sièges posés ici pour toute la somme
...
[PRD](../PRD/PRD.md) pour une décision ou un régime, au [TOC](../PRD/TOC.md) pour un réalignement de
...
|---|---|---|
| **R-IV-76** | ch. 22 | ☑ **PRD v0.10** — l'assignation du point *(a)* de la relève v0.10 au ch. 17 est **maintenue et déclarée non exécutée** ; elle entre au **registre des reprises dues avant publication du Livre II** (J-IV-6). ⚠ *Une arrivée se déclare aux deux bouts* |
| **R-IV-77** | ch. 22 | ☑ **PRD v0.10 §8** — la règle d'extinction est **reformulée par objet** : *seuls les deux dispositifs hérités du Vol. I s'éteignent au Livre III* ; **le dispositif du Vol. II n'est pas visé** |
| **R-IV-78** | ch. 23 | ☑ **close par la même clarification** — ⚠ *le § 23.4 en est la preuve : le plan **prescrit** l'encadré, et il emploie le dispositif du Vol. II* |
| **R-IV-79** | ch. 23 | ☑ **PRD v0.10, volet résiduel de G-1** — le cardinal « deux offres sur cinq de première main » entre au **registre des faits à re-mesurer au gel de publication** ; **le tableau 23.1 porte sa date** |
| **R-IV-80** | ch. 24 | ☑ **TOC v0.26** — la table détaillée du § 24.6 **déplie le §4.7.4** ; ⚠ *la ligne Fusion primait, et la pièce l'avait suivie* |
| **R-IV-81** | ch. 24 | ☑ **PRD v0.10, G-1** — la relève v0.19 du § 24.8 entre au **registre des relèves dues**, avec son critère de clôture. ⚠ **Ce n'est pas un cas de D-9** : *là où le § 17.5 nommait un vide **sans source identifiée**, celui-ci en a **une, nommée et datée***. *Une relève qui désigne sa source et reste non consommée est une **dette d'instruction**, non une lacune de socle* |
| **R-IV-82** | ch. 24 | ☑ **PRD v0.10, dette d'appareil portée et non exécutée** — ⚠ *versement reporté à une passe unique, le fichier étant modifié par la passe concurrente des Livres IV et V* |
| **R-IV-83** | ch. 25 | ☑ **TOC v0.26, décisions 8 et 14** — thèse réalignée : « couverture par inférence **d'analystes**, **à traiter** comme acquise ». ⚠ *Deux altérations, deux garde-fous touchés* : le retrait de « d'analystes » **effaçait l'objet de PRD Vol. II §8.2.4** ; « doivent » **convertissait en prescription une lecture de l'auteur** |
| **R-IV-84** | ch. 25 | ☑ **TOC v0.26, Annexe C, troisième table** — la lacune **PRD Vol. II §10.4** est *couverte en [C] par le Vol. I §5.3.7, à instruire pour élévation*. ⚠ **Couverte en [C] ne vaut pas comblée** |
| **R-IV-85** | ch. 25 | ☑ **PRD v0.10 §13** — le relevé pièce par pièce des **quinze remontées ouvertes du Vol. III** devient **condition de sortie de G-4 pour le Livre III comme pour le Livre II** ; ⚠ **il est dû** : *un relevé fait pour un Livre ne couvre pas un autre* |
| **R-IV-86** | ch. 26 | ☑ **PRD v0.10, G-1** — les deux cardinaux datés du ch. 26 et **l'étape parlementaire de C-36** entrent au registre des faits à re-mesurer |
| **R-IV-87** | ch. 27 | ☑ **TOC v0.26, décisions 8 et 14** — la restriction « **sous l'article 12.1 du moins** » est **rétablie** à la thèse du ch. 27. ⚠ *Sans elle, l'énoncé devenait une proposition générale sur le droit canadien que **trois textes sur quatre ne portent pas*** |
| **R-IV-88** | ch. 27 | ☑ **TOC v0.26, Annexe C** — ⚠ **la divergence cesse d'être une divergence de date** : le troisième terme, extrait à la source primaire le 21 juillet 2026, établit qu'**aucune des deux dates ne figure aux pages officielles**. *La somme écrit **« avril 2026 »** et déclare les trois états* |
| **R-IV-89** | ch. 27 | ☑ **TOC v0.26** — l'intitulé du § 27.2 porte désormais l'**articulation corrigée** : *une obligation inconditionnelle, **trois informations dues sur demande dont le droit de rectification**, un alinéa distinct* |
| **R-IV-90** | ch. 28 | ☑ **TOC v0.26, Annexe C** — la limite de périmètre de l'avis 11-348, **ouverte par la rédaction du Vol. II et jamais portée à un registre**, y entre. ⚠ *Ce n'est pas une lacune couverte en [C] : c'est une lacune que personne ne portait* |
| **R-IV-91** | ch. 29 | ☑ **TOC v0.26 — la table du § 29.1 n'est PAS augmentée**, et le motif est écrit : *dériver deux contraintes neuves depuis une pièce redécouperait un chapitre-pivot conservé intact*, ⚠ **et surtout le Vol. II n'a pas conduit cette dérivation — la somme ne la fait pas à sa place**. ☐ **Dette portée à G-3** |
| **R-IV-92** | ch. 30 | ☑ **TOC v0.26** — la table de couverture du ch. 30 **déclare le recouvrement** : le §4.8 et le §5.3 du Vol. I y arrivent tous deux et **portent le même fait à deux états datés** |
| **R-IV-93** | ch. 30 | ☑ **TOC v0.26** — les deux instances de normalisation que le socle ne documente pas sont **marquées telles** à l'intitulé du § 30.3.3 |
| **R-IV-94** | ch. 31 | ☑ **close avec R-IV-82** — ⚠ **huit sièges déclarés au plan et non contrôlés** pour le seul Livre III ; *versement reporté à une passe unique* |
| **R-IV-95** | ch. 32 | ☑ **PRD v0.10, registre des corrections dues de G-3** — le **fait négatif vérifié sur le standard technique** est porté par **deux entrées de socle pour un seul balayage** ; ⚠ *sans déduplication explicite, un chapitre aval en tirerait une **corroboration qui n'existe pas*** |
...
**Quatre constats méritent d'être retenus.**

1. ⚠ **Deux thèses sur quinze portaient une forme que le plan avait altérée en la reprenant — et
   l'altération allait, cette fois, dans le sens du *durcissement*.** *Au Livre II, cinq thèses citaient
   **une forme que leur source avait bornée après coup** : le plan **n'avait pas suivi**. Ici, le plan a
   **retranché une borne que sa source portait** — « d'analystes » au ch. 25, « sous l'article 12.1 du
   moins » au ch. 27.* ⚠ ***La classe est inverse et le remède identique*** : *la collation de la thèse
   contre le texte rédigé, **avant** la rédaction, les a trouvées toutes les deux — **et aucune relecture
   du corps ne les aurait vues**, puisque les corps étaient déjà écrits sous la forme bornée.*
2. ⚠ **Une divergence tranchée a cessé d'être une divergence, et personne ne l'avait vu.** *Le plan
   arbitrait la date de publication de la ligne directrice québécoise **en faveur du Vol. II**. Le
   Vol. III, par extraction à la source primaire le 21 juillet 2026, établit qu'**aucune des deux dates
   ne figure aux pages officielles** — et le **Vol. I en porte une troisième**.* ⚠ ***Une divergence dont
   on découvre qu'aucun de ses termes n'est à la source n'est plus une divergence : c'est une absence de
   datation*** — *et l'arbitrage qui la tranchait portait sur un objet inexistant.*
3. ⚠ **La classe « lacune de couverture couverte par un autre volume » atteint sept occurrences en trois
   Livres** — *R-IV-12 et R-IV-13 au Livre I, R-IV-14, R-IV-18 et R-IV-35 au Livre II, **R-IV-84 et
   R-IV-92 ici**.* ⚠ **Et une variante neuve apparaît** : *R-IV-90 nomme une lacune que **personne ne
   porte** — ni couverte, ni inscrite —, et **R-IV-97 une catégorie d'affirmations que le régime de
...
|---|---|---|
| **Le KYA** (connaissance de l'agent) — Vol. I §5.5.4 | **ch. 18 § 18.1** (Livre II) | **siège amont** — ⚠ *le ch. 31 § 31.4 le renvoie et ne le reprend pas* |
| **La triade létale** | **ch. 19 § 19.2** (Livre II) | **siège amont** — le ch. 31 § 31.4.1 n'en traite que la **transposition financière** |
| **Le socle IAM** | **ch. 3** (Livre I) | **siège amont** — les ch. 24 et 31 y renvoient |
| **L'encadré de désambiguïsation à quatre branches** | **ch. 7 § 7.5** (Livre I) | **siège amont** — les ch. 22, 24, 35 et 36 y renvoient à chaque emploi du sigle |
| **Le §5.0 du Vol. I** (orientation, durcisseurs, sourçage) | **avant-propos** | **acheminé** — il en fournit le mode d'emploi de lecture |
| **Le maillage réglementaire transversal** (Vol. I §5.3) | **ch. 30** | ⚠ *sorti du ch. 31, dont la thèse l'énumère pourtant* — **arbitrage déclaré** |
| **Observabilité, FinOps, architectures de référence, modèle de maturité financier, grille de décision** | **Livre IV** | **hors périmètre** — Vol. I §4.9, §4.12, §5.12.1-5.12.3 |

⚠ **Et deux matières que le Livre déclare sans les traiter.** *(a)* Le **§ 24.8** — capacité d'inférence,
budget de latence, contention — est écrit **au régime de repli que le plan lui-même prescrit** : *le vide
est exposé, la question instruisible formulée avec son critère de clôture, **et aucune ligne de doctrine
n'est écrite là où le socle est muet**.* *(b)* Le **§ 27.1** déclare que **seules les dates de la ligne
directrice québécoise sont au socle du Vol. II, jamais son contenu** — ⚠ **et le ch. 30 § 30.2.7 en
décrit le contenu, en [C], depuis le Vol. I** : *les deux énoncés sont **logiquement compatibles**, et
la lacune **reste ouverte**.*
...
```bash
python .claude/skills/chapitre-compendium/scripts/rendre-piece.py "2 - Compendium/Livre III/<pièce>.md"
```

```bash
python .claude/skills/chapitre-compendium/scripts/verifier-piece.py "2 - Compendium/Livre III/<pièce>"
```
...
2. **Lire l'intégralité du périmètre de fusion.** ⚠ *Le ch. 30 en a fourni la démonstration la plus
   ...
   datés** — un chapitre écrit sur une seule des deux sources aurait présenté un état périmé comme
   courant.*
3. ⚠ **Comparer la thèse du TOC au texte rédigé de sa source avant d'écrire** (décision 14). *Deux thèses
   sur quinze portaient **une borne retranchée par le plan** — **la classe inverse de celle du Livre
   II**, et le même remède.*
4. ⚠ **Ne jamais écrire une section dont le plan déclare le socle « à établir avant rédaction ».** *Le
   § 24.8 est le cas de ce Livre ; **le plan y prescrivait lui-même le repli**, et c'est celui-là qui a
   été suivi.*
5. Porter l'en-tête à cinq champs du PRD §6, **garde-fous à zéro occurrence compris**, puis la thèse
   citée depuis le TOC.
6. ⚠ **Un siège neuf s'ajoute à la table `SIEGES`, la pièce porteuse écrit son marqueur, et le harnais de
   mutation se rejoue — les trois gestes, jamais deux sur trois.** *Ici **un seul des trois** a pu être
   fait, et le motif est écrit plus haut.*
7. Écrire le `.md` et le `.html` **dans la même passe**, faire passer les huit contrôles, et les
   committer ensemble.
