...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 43.7](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé le 27 juillet 2026 avant G-3, G-4 et G-5, hors de l'ordre du PRD §6 ; porte trois sièges pour la somme, versés à check-sieges.py ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source 16 juillet 2026 (Vol. II), 21 juillet 2026 (Vol. III), juin 2026 (Vol. I) ; volet résiduel de G-1 non instruit |
| **Socle mobilisé** | non ré-adossée, correspondance S-nnn due : Vol. II et Vol. III par identifiants d'origine, Vol. I en [C] ; F-92, F-96 et H-15 hors socle ; H-31 non élevable |
| **Garde-fous balayés** | Vol. II — R-2 : une occurrence ; R-3 : une occurrence ; R-5 : une occurrence ; R-8 : une occurrence ; R-1, R-4, R-6, R-7 : zéro occurrence · Vol. III — R-09 : deux occurrences ; R-01 : une occurrence ; R-06 : une occurrence ; R-13 : une occurrence ; R-02 et R-14 : zéro occurrence de l'identifiant ; R-03 à R-05, R-07, R-08, R-10 à R-12 : zéro occurrence |
| **Volumétrie cible** | Réel : 6 125 mots de corps pour une cible ≈ 6 500 mots (−5,8 %), mesure `decompte.sh` |
...
**F-37**, ⚠ **préimpression non révisée**). ⚠ **Deux avertissements les accompagnent.** *Un* : le
socle écrit « contraintes » **sans
...
⚠ **La liste est une reprise attribuée, non une invention de la somme.** *Les cinq points sont posés
par le **texte rédigé du Vol. II**, à son ch. 19 §19.3, sous le marquage « Lecture de l'auteur » ; le
Vol. III les reprend en **H-15** comme **thèses d'un volume antérieur, à prolonger et à attribuer,
jamais comme acquis**, et **H-15 n'entre pas au socle consolidé** — son origine n'est pas un
identifiant de socle et ne peut pas l'être.* **Leur dérivation est celle que la source énonce
elle-même, transposée à la numérotation de la somme : ces points ne sont pas déduits d'une source —
ce sont les cinq zones de compensation du ch. 42, chacune assignée à la couche qui doit la porter.**
⚠ **Quatre deviennent ici des points de contrôle
...
auto-déclaré.** ⚠ **L'attribution suit la source et ne la devance pas** : *le Vol. I rapporte le
premier jeu **sans nommer d'analyste**, et la somme reporte cet état plutôt que de lui prêter une
attribution.* Il le donne **de statut analyste ou enquête, marqué « ressources vivantes » et à
re-vérifier** : *environ un tiers des organisations à un niveau de maturité 3 ou
...
littéral **« degré 3 » compte quatre occurrences**, chacune portant son degré. ⚠ **Le marqueur
« auto-déclaré » compte six occurrences, et elles ne portent pas toutes une métrique attribuable — la
répartition se déclare plutôt qu'elle ne s'agrège** : **trois portent des chiffres nommément
attribués** — **TD et Layer 6**, **Scotiabank**, **McKinsey/QuantumBlack et MIT NANDA**, nommés en
toutes lettres (décision 15 du TOC, alinéa b, premier titre) ; **une porte le jeu de trois chiffres
que la source ne nomme pas**, état reporté et non suppléé (§ 43.5) ; **une qualifie le statut
auto-déclaré d'une pré-version** (§ 43.1), dont l'attributeur est l'éditeur du composant, *non nommé
au titre de la neutralité que ce chapitre déclare* ; **une est une lecture sur la valeur des
enquêtes** (§ 43.5) et ne porte aucun chiffre. ⚠ **Les cinq points de contrôle obligatoires sont une
reprise attribuée, et la pièce l'écrit désormais** : *ils sont posés par le texte rédigé du Vol. II
(ch. 19 §19.3), repris en **H-15** du Vol. III comme thèses d'un volume antérieur — **hors socle
consolidé** — ; leur dérivation à partir des cinq zones du ch. 42, dont quatre seulement deviennent
des points de contrôle, est celle que la source énonce elle-même.*
