...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 37.10](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé le 27 juillet 2026 avant G-3, G-4 et G-5, hors de l'ordre du PRD §6 ; G-4 et G-5 ouvertes ; écart de portes le plus large du compendium ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source 21 juillet 2026 (Vol. III) et juin 2026 (Vol. I) ; aucun fait périssable repris à la source primaire |
| **Socle mobilisé** | aucune entrée consolidée, re-ancrage dû : Vol. III, ch. 22-23, source rédigée non publiable sans vote ; Vol. I, §1.3.4 et §2.10.3-2.10.4, en [C] ; Vol. II F-01 pour une réserve |
| **Garde-fous balayés** | Vol. III — R-09 : neuf occurrences ; R-14 : sept occurrences ; R-02 : cinq occurrences ; R-01 : deux occurrences ; R-04 : trois occurrences ; R-12 : deux occurrences ; R-13 : une occurrence ; R-03 : une occurrence ; R-11 : une occurrence ; R-05 à R-08, R-10 : zéro occurrence · Vol. II — R-8 : trois occurrences ; R-1 à R-7 : zéro occurrence |
| **Volumétrie cible** | Réel : 10 286 mots de corps pour une cible ≈ 11 000 mots (−6,5 %), mesure `decompte.sh` |
...
services pré-agentique** — le socle transposable posé au **ch. 1 § 1.3.4** — **n'est aucune des six
branches que R-04 du Vol. III énumère** : sa branche (e) vise le plan de contrôle **au sens
infrastructure** de sa propre Partie VII, agentique et obtenu *par* filiation, non le patron dont la
filiation part. Le § 37.1 l'emploie dans ce sens pré-agentique, et le dit.
...
profondeur empile des couches insuffisantes précisément parce qu'aucune ne suffit* — et c'est la
raison pour laquelle **aucune action irréversible ne dépend d'une seule couche**, principe posé au
ch. 6 et instancié au ch. 45.
...
**Ce qui est enfreint** — *état à la rédaction, et il ne se réécrit pas quand l'aval bouge.* Portes
**G-3** (refonte du socle, **non entamée à la rédaction** ; ☑ **franchie depuis, le 28 juillet 2026**,
PRD v0.14), **G-4** (collation de fond contre le Vol. III rédigé, volet de fond dû — *préalable
déclaré du premier mouvement de ce Livre*) et **G-5** (arbitrage du risque 14, décision d'auteur
**D-2**, **non prise à la rédaction** ; ☑ **prise le 27 juillet 2026 par une autre passe, et la porte
n'est pas franchie pour autant** — *une décision prise n'est pas une porte franchie* — *porte qui
conditionne le Livre IV entier*) ; **volet résiduel de G-1** non instruit pour ce Livre ; **ordre de
rédaction du PRD §6**, qui place les Livres I et III avant celui-ci et le premier mouvement du
Livre IV en troisième position. Instruction d'auteur du **27 juillet 2026**.
...
ni la v0.29 ni la v0.30 ne modifient*, et le § 37.0 est une introduction de chapitre et de Livre.
⚠ **Une déviation d'intitulé est fondée et se déclare** (décision 8, reprise en décision 15
alinéa c) : le § 37.9 **allonge** le titre du plan
...
n'établit pas — ⚠ *le marqueur paraît deux fois de plus **hors** du domaine compté, et aucune des
deux n'est un marquage de cette pièce : à la thèse du second mouvement, qui la cite depuis le TOC, et
à la présente phrase. Onze occurrences au fichier, neuf au domaine.* Enfin,
