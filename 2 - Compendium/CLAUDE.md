...
2. **Contrôles** : `python PRD/check-toc.py` (versionné dans `PRD/` depuis la v0.12 du 23 juillet
   2026 — contrôles C1-C14, domaine : chapitres 1-50, cinq livres depuis la v0.20) **avant toute publication** ;
