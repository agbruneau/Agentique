...
⚠ **`TOCAll.md` n'est pas non plus un livrable.** Copie de travail de [`PRD/TOC.md`](PRD/TOC.md) (créée le 25 juillet 2026), augmentée pour les **chapitres 1 à 34 sur 57** (Livres I à V) d'une table des matières détaillée dérivée du **texte rédigé** des sources — Vol. I *Monographie* §1.x-§7.x, Vol. II *Monographie* ch. 1-13 et 21, Vol. III *Monographie* ch. 1-21 ; chaque sous-section porte sa provenance et chaque chapitre porte sa table de couverture (décision 6). **Elle n'a pas d'autorité propre** : en cas d'écart avec la ligne Fusion du chapitre dans `PRD/TOC.md`, celle-ci prime. Elle n'est **pas couverte par `check-toc.py`** (hors de son domaine, `PRD/`) et se **désynchronise** à la prochaine passe du TOC si elle n'est pas reportée à la main. Si l'exercice s'étend aux 23 chapitres restants, le repenser comme annexe du TOC plutôt que comme copie parallèle.
