...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 19.7](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé le 27 juillet 2026 avant G-3 et G-4 ; G-4 ouverte, ré-adossement dû ; CA-IV-11 insatisfaite, aucune relecture dédiée : rien ici n'est une attestation ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source juin 2026 (Vol. I) et 21 juillet 2026 (Vol. III) ; identifiants de vulnérabilité cités comme jalons datés |
| **Socle mobilisé** | Vol. III, ch. 12, dix-sept entrées propres et quatre héritées, dont H-24 et H-26 en [C] ; Vol. I, §2.10.1-2.10.2, en [C] ; F-26 à vote adversarial incomplet ; re-citation en S-nnn due |
| **Garde-fous balayés** | Vol. III — R-08 : un marqueur (siège) ; R-02 : un marqueur ; R-14 : un marqueur ; R-01, R-03 à R-07, R-09 à R-13 : zéro marqueur · Vol. II — R-1 à R-8 : zéro marqueur |
| **Volumétrie cible** | Réel : 6 133 mots de corps pour une cible ≈ 5 000 mots (+22,7 %), mesure `decompte.sh` |
...
| **Volumétrie cible** | ≈ **5 000 mots** de corps (§ 19.0 à § 19.6), **cible dérivée** de l'enveloppe du Livre (50 000 mots, TOC v0.24) au prorata des sections. ☑ **Décompte publiable depuis G-2** ; **réel : 6 133 mots — ⚠ *re-mesurés le **2 septembre 2026** ; l'en-tête portait **5 779**, soit **+354** : la mesure n'avait pas suivi les passes de relecture*** par [`PRD/decompte.sh`](../PRD/decompte.sh) — **+15,6 %**, re-mesuré au commit de la contre-relecture du 28 juillet 2026 (⚠ *deux valeurs antérieures sont périmées : **5 529**, +10,6 % à la rédaction, et **5 764**, +15,3 % à la première relecture*). Les **250 mots** de l'écart cumulé se ventilent en **235** pour les attributions rétablies au titre de la décision 15 et **15** pour le garde-fou d'homonymie rétabli au § 19.0 et la date d'avril 2026 rétablie au § 19.5 — **aucune amputation n'a été faite**, D-4. ⚠ La volumétrie du Livre est relevée au [`README.md`](README.md) du dossier et alimente **D-4** par **R-IV-17** |
