...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 16.6](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé le 27 juillet 2026 avant G-3 et G-4 ; G-4 ouverte ; chapitre de composition, où chaque affirmation se trace vers un chapitre amont ou se marque Lecture de l'auteur ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source juin 2026 (Vol. I), 16 juillet 2026 (Vol. II), 21 juillet 2026 (Vol. III) ; une échéance à venir au § 16.4, le 1ᵉʳ mai 2027 |
| **Socle mobilisé** | aucun énoncé re-résolu au socle, aucun lot propre : Vol. III, ch. 8 et §7.4, Vol. II, §8.4 (F-07, F-08), Vol. I, §7.4.2, en [C] ; H-18 et F-55 en [C] |
| **Garde-fous balayés** | Vol. II — R-2 et R-3 : quatre marqueurs chacun (siège) ; R-4 : zéro marqueur ; R-1, R-5 à R-8 : zéro marqueur · Vol. III — R-01 : trois marqueurs ; R-02 à R-14 : zéro marqueur |
| **Volumétrie cible** | Réel : 5 523 mots de corps pour une cible ≈ 4 500 mots (+22,7 %), mesure `decompte.sh` |
...
| **Volumétrie cible** | ≈ **4 500 mots** de corps (§ 16.0 à § 16.5), **cible dérivée** de l'enveloppe du Livre (50 000 mots, inchangée au TOC v0.30) au prorata des sections. ☑ **Décompte publiable depuis G-2** ; **réel : 5 523 mots — ⚠ *re-mesurés le **2 septembre 2026** ; l'en-tête portait **4 943**, soit **+580** : la mesure n'avait pas suivi les passes de relecture*** par [`PRD/decompte.sh`](../PRD/decompte.sh) — **+9,8 %** (re-mesuré au commit du 28 juillet 2026, au terme de la **seconde** passe de relecture ; **4 932 mots et +9,6 %** au terme de la première, **4 828 mots et +7,3 %** à la rédaction du 27 juillet 2026). ⚠ La volumétrie du Livre est relevée au [`README.md`](README.md) du dossier et alimente **D-4** par **R-IV-17** |
