...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 18.5](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : écrit le 27 juillet 2026 avant G-3 ; G-4 ouverte ; siège unique du KYA pour la somme (§ 18.1) ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source juin 2026 (Vol. I) et 21 juillet 2026 (Vol. III) ; le plus dense du mouvement en objets périssables |
| **Socle mobilisé** | non réancrée sur la série consolidée : Vol. III, ch. 11, dix-neuf entrées propres et H-19 en [C] ; Vol. I, §5.5.4, §3.6.5 et §7.4.3, en [C] ; F-56 rétrogradée en [C] à la refonte |
| **Garde-fous balayés** | Vol. III — R-02 : trois marqueurs ; R-14 : un marqueur ; R-01, R-03 à R-13 : zéro marqueur · Vol. II — R-1 à R-8 : zéro marqueur |
| **Volumétrie cible** | Réel : 4 576 mots de corps pour une cible ≈ 3 800 mots (+20,4 %), mesure `decompte.sh` |
...
|---|---|---|---|
| **W3C** | Groupe communautaire « Agent Identity Registry Protocol » — *ni voie des normes, ni Recommandation* | proposé le **22 avril 2026** ; livrables annoncés : une méthode d'identifiant décentralisé et un format d'accréditation d'agent ; **36 participants non-présidents** affichés ; **ni rapport ni brouillon publié** | F-30 **[B]** ; F-50 **[B, degré 2]** |
| **W3C** | Groupe communautaire « AI Agent Protocol » — *même statut* | hébergé depuis le **8 mai 2025** ; charte déclarant un modèle d'identité pour les agents d'IA ; **254 participants non-présidents** affichés ; **aucun document produit n'a été ouvert** | F-83 **[B]** |
| **OpenID Foundation** | Groupe communautaire « Artificial Intelligence Identity Management » (AIIM) | sa charte place **hors de son périmètre** le développement de protocoles de normalisation mondiaux liés à l'identité des agents, **et renvoie ce travail à un groupe de travail** | **F-48 [A, degré 2]** |
...
| **IETF** | `draft-sharif-openid-agent-identity` (soumission individuelle) | déposé le **26 mars 2026** en `-00` ; ☑ **revalidé le 2 septembre 2026** : **`-01` déposé le 26 août 2026**, expirant le **27 février 2027** — *l'échéance de septembre est sans objet* ; **toujours non adopté** par un groupe de travail | F-50 |
| **IETF** | `draft-drake-agent-identity-registry-03` (soumission individuelle) | déposé le **23 mai 2026**, expirant le **24 novembre 2026** ; **non adopté** par un groupe de travail | F-50 |
...
| **NIST — CAISI** | *AI Agent Standards Initiative* | annoncée le **17 février 2026** ; troisième axe portant sur la sécurité et l'identité ; **volet identité à l'état de projet de document de concept** | F-56 **[C]** |
| **Akamai** | Cadre « Know Your Agent » | **annoncé le 15 juin 2026** au sein d'un cadre de sécurité agentique | F-49 **[B, degré 3]** |
...
Protocol » du W3C**, à qui il est attribué à chaque occurrence : il compte des
...
- **R-IV-31 — close par inscription au volet résiduel de G-1 (PRD v0.9).** Le cardinal « **neuf
  ...
  **porte sa date**. ⚠ **L'obligation est inscrite parce que sa fragilité est datée** : deux des neuf
  ...
  ☑ **RE-MESURÉ LE 2 SEPTEMBRE 2026**, première échéance passée
  ([rapport](../PRD/revalidation-2026-09-02.md)) : ⚠ **le cardinal « neuf chantiers, six
  organisations » est INCHANGÉ**, et il l'est *pour une raison que la remontée n'avait pas prévue*.
  **Les deux échéances redoutées ne sont pas survenues** : le premier brouillon a été **renouvelé en
  `-01` le 26 août 2026** — l'échéance du 27 septembre est sans objet, la neuve tombe en février 2027
  —, et le second **n'a pas bougé**, son terme du 24 novembre 2026 restant ouvert. ⚠ **La fragilité
  que la remontée nommait était donc mal située** : *une date d'expiration d'`Internet-Draft` se
  repousse par un dépôt de routine, et n'annonce rien.* **Ce qui ferait tomber une ligne de ce tableau
  est l'ADOPTION par un groupe de travail — qui change la citabilité — ou l'ABANDON — qui arrête le
  renouvellement.** *Aucun des deux n'est survenu : les deux brouillons restent des soumissions
  individuelles non adoptées.* ☐ **L'obligation de re-mesure au gel de publication reste inscrite**,
  et elle est désormais **rédigée sur le bon critère.**
