...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 13.6](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé le 27 juillet 2026, G-3 et G-4 alors ouvertes ; G-4 reste ouverte, sous le régime de la source rédigée non publiable (PRD §7.2) ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source juin 2026 (Vol. I) et 21 juillet 2026 (Vol. III) ; chapitre le plus périssable du mouvement |
| **Socle mobilisé** | identifiants sources préfixés, non re-cités en S-nnn : Vol. III, ch. 3, douze entrées propres, H-18 et H-20 en [C] ; Vol. I, §3.6.4 et §7.4.3, en [C] |
| **Garde-fous balayés** | Vol. III — R-14 : trois marqueurs ; R-02 : deux marqueurs ; R-09 : un marqueur ; R-01, R-03 à R-08, R-10 à R-13 : zéro marqueur · Vol. II — R-1 à R-8 : zéro marqueur |
| **Volumétrie cible** | Réel : 5 055 mots de corps pour une cible ≈ 4 000 mots (+26,4 %), mesure `decompte.sh` |
...
| **Volumétrie cible** | ≈ **4 000 mots** de corps (§ 13.0 à § 13.5), **cible dérivée** de l'enveloppe du Livre (50 000 mots, TOC v0.30) au prorata des sections. ☑ **Décompte publiable depuis G-2** ; **réel : 5 055 mots — ⚠ *re-mesurés le **2 septembre 2026** ; l'en-tête portait **4 529**, soit **+526** : la mesure n'avait pas suivi les passes de relecture*** par [`PRD/decompte.sh`](../PRD/decompte.sh) — **+13,2 %**, re-mesuré au commit du 28 juillet 2026 (**3 947 mots à la rédaction**, soit −1,3 % ; **4 358 mots** au terme de la première passe de relecture, soit +9,0 %). ⚠ **L'écart vient des constats de re-datation et des bornes versés au corps par les deux passes de relecture, jamais d'un gonflement** — *rien n'a été amputé pour le contenir, D-4 l'interdisant, et une borne coûte des mots là où une coupe en épargne.* ⚠ **Un écart individuel ne se lit pas seul** : la volumétrie du Livre est relevée pièce par pièce au [`README.md`](README.md) du dossier, et c'est elle qui alimente la **décision d'auteur D-4**, ouverte, par la remontée **R-IV-17** du ch. 12 |
