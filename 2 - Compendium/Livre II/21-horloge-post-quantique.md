...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 21.10](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé le 27 juillet 2026 avant G-3 et G-4 ; G-4 ouverte ; siège de l'horloge post-quantique pour la somme (§ 21.1) ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source juin 2026 (Vol. I) et 21 juillet 2026 (Vol. III) ; les cibles prêtées au QSFF par le Vol. I restent introuvables (§ 21.7) |
| **Socle mobilisé** | aucun énoncé re-résolu au socle : Vol. III, ch. 16-18, Vol. I, §7.4.1 et §7.4.4, en [C] ; cinq entrées en [C] ; S-082 changée, S-153 non établie |
| **Garde-fous balayés** | Vol. III — R-11 : trois marqueurs (siège) ; R-02 : quatre marqueurs ; R-01, R-03 à R-10, R-12 à R-14 : zéro marqueur · Vol. II — R-1 à R-8 : zéro marqueur |
| **Volumétrie cible** | Réel : 9 724 mots de corps pour une cible ≈ 5 800 mots (+67,7 %), mesure `decompte.sh` |
...
dire par quelle porte il entre.** ⚠ **Aucune entrée héritée ne couvre le §7.4.4 du Vol. I *Monographie***
— *le document se nomme, ce volume ayant deux documents cités par ce chapitre (décision 7)* : là où le
...
2. **Les décomptes sont publiables** (G-2). Écart de **+55,8 %** au terme de la contre-relecture du
   28 juillet 2026 — ⚠ *son rang dans le Livre ne se déclare pas tant que les neuf pièces voisines sont
   en relecture* ; **la volumétrie du Livre entier** alimente **D-4** par **R-IV-17**. ⚠ **Les décomptes
   d'occurrences de cette pièce, eux, n'étaient PAS publiables au terme de la relecture** : deux
   portaient le compte du fichier entier là où la décision 16 borne au corps — *un cardinal mesuré sur
   un domaine autre que celui qu'il déclare est faux même quand son balayage est exhaustif.*
...
absences **portent leur degré** : **seize marqueurs « degré 3 »** — dont deux qualifient une colonne
