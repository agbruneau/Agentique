...
| Champ | Valeur — résumé du 15 septembre 2026 ; en-tête entier en fin de pièce, [§ 15.4](#en-tête-de-rédaction) |
|---|---|
| **Statut** | Archive de travail, hors compte des livrables ([D-18](../PRD/PRD.md#d-18)) ; brouillon non publiable : rédigé hors portes le 27 juillet 2026 ; G-4 ouverte ; chapitre à plus haut risque de surinterprétation, sans relecture adversariale (CA-IV-13) ; aucun énoncé central (CA-IV-01) |
| **Date de gel** | 27 juillet 2026, gel unique (D-1) ; gels de source juin 2026 (Vol. I), 16 juillet 2026 (Vol. II), 21 juillet 2026 (Vol. III) ; corps non re-collationné contre le volet résiduel de G-1 |
| **Socle mobilisé** | aucun énoncé re-résolu au socle : Vol. III, ch. 5-7 hors §7.4, Vol. II, §8.2 (F-08), Vol. I, §3.4 et §3.6.3, en [C] ; F-36 et F-55 du Vol. III en [C] |
| **Garde-fous balayés** | Vol. II — R-3 : deux marqueurs ; R-2 : un marqueur ; R-1, R-4 à R-8 : zéro marqueur · Vol. III — R-02 : sept marqueurs ; R-07 : deux marqueurs ; R-01 : un marqueur ; R-03 à R-06, R-08 à R-14 : zéro marqueur |
| **Volumétrie cible** | Réel : 8 525 mots de corps pour une cible ≈ 5 800 mots (+47,0 %), mesure `decompte.sh` |
...
| **Volumétrie cible** | ≈ **5 800 mots** de corps (§ 15.0 à § 15.3), **cible dérivée** de l'enveloppe du Livre (50 000 mots, TOC v0.24) au prorata des sections — ce chapitre en porte trois, mais **onze sous-sections**, ce que la dérivation au prorata des seules sections `##` sous-estime. ☑ **Décompte publiable depuis G-2** ; **réel : 8 525 mots — ⚠ *re-mesurés le **2 septembre 2026** ; l'en-tête portait **8 494**, soit **+31** : la mesure n'avait pas suivi les passes de relecture*** par [`PRD/decompte.sh`](../PRD/decompte.sh) — **+46,4 %** (re-mesuré au terme de la passe de relecture du 28 juillet 2026 ; le réel est passé de **8 187** à **8 494 mots**, les corrections de régime de preuve ajoutant des bornes sans rien retrancher). ⚠ **Le rang de cet écart au sein du Livre n'est pas re-mesuré** : les autres pièces sont relues dans la même passe, et *un cardinal mesuré pendant que des pièces s'écrivent est faux à la seconde où on le publie*. ⚠ La volumétrie du Livre est relevée au [`README.md`](README.md) du dossier et alimente **D-4** par **R-IV-17** |
