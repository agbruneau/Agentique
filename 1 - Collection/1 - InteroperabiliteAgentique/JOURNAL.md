# Journal — `1 - Collection/1 - InteroperabiliteAgentique/`
...
Le texte d'origine se relit par `git show 5cdb5bb:"1 - Collection/1 - InteroperabiliteAgentique/README.md"`. Trois dossiers ont changé de nom le 5 septembre 2026 — `3 - Traité/` est
...
|---|---|---|
| [`README.md`](#page-readme) | 137 | [Les sept chapitres](#les-sept-chapitres) · [Architecture détaillée de solution (ADS) — Annexe B](#architecture-détaillée-de-solution-ads--annexe-b) · [Article de synthèse — retiré du dossier](#article-de-synthèse--retiré-du-dossier) · [Veille technologique — déplacée hors de ce dossier](#veille-technologique--déplacée-hors-de-ce-dossier) · [Démonstrateur Borealis (code) — retiré du dépôt](#démonstrateur-borealis-code--retiré-du-dépôt) · [Structure du dossier](#structure-du-dossier) · [Construire les PDF](#construire-les-pdf) · [État](#état) |

<a id="page-readme"></a>

---

*Page reçue : `README.md`, 137 lignes au commit `5cdb5bb`.*
