...
| Filiation | Premier panneau du triptyque : Vol. I (**théorie mondiale**, gel juin 2026) → Vol. II *Orchestration agentique* (cas canadien réglementé) → Vol. III *L'entreprise agentique*. Les volumes aval citent le Vol. I sous **deux numérotations distinctes** : les renvois §7.x résolvent contre `Monographie.md` (numérotation par chapitre), les renvois §10, §11.5 et tableau 15 contre `Synthese Monographie.md` (numérotation §3-§12) — nommer le fichier à chaque renvoi. |
...
⚠ **La veille technologique n'est pas un livrable de ce volume.** Déplacée à la racine du dépôt (`Veille Technologique.md`, **éd. du 8 août 2026**, 100 p.), elle couvre les trois volumes et cite le Vol. I en §4.12 (démonstrateur `Borealis-Go`, réf. [217] — *numéro inchangé par la renumérotation du 8 août 2026*). ⚠ *Ses conventions et sa chaîne de rendu relevaient d'un `CLAUDE.md` de dépôt qui a été retiré le 31 juillet 2026 (commit `41666d0`) : ce volume n'a plus de document de conventions au dépôt.*
