...
Le texte d'origine se relit par `git show 5cdb5bb:"1 - Collection/README.md"`. Trois dossiers ont changé de nom le 5 septembre 2026 — `3 - Traité/` est
...
|---|---|---|
| [`README.md`](#page-readme) | 491 | [Vue d'ensemble](#vue-densemble) · [Le fil conducteur : du protocole à la confiance](#le-fil-conducteur--du-protocole-à-la-confiance) · [Vol. I — Interopérabilité agentique en entreprise](#vol-i--interopérabilité-agentique-en-entreprise) · [Vol. II — Orchestration agentique](#vol-ii--orchestration-agentique) · [Vol. III — L'entreprise agentique](#vol-iii--lentreprise-agentique) · [Les trois monographies en dialogue](#les-trois-monographies-en-dialogue) · [Protocoles et standards structurants](#protocoles-et-standards-structurants) · [Concepts transversaux](#concepts-transversaux) · [Recommandations consolidées](#recommandations-consolidées) · [Ordre de lecture](#ordre-de-lecture) · [Volumétrie du corpus](#volumétrie-du-corpus) · [Avertissements](#avertissements) · [Structure du dossier](#structure-du-dossier) · [Décomptes du dépôt final](#décomptes-du-dépôt-final) |

<a id="page-readme"></a>

---

*Page reçue : `README.md`, 491 lignes au commit `5cdb5bb`.*

# Le corpus agentique — synthèse consolidée des trois monographies

> **Auteur :** André-Guy Bruneau, M.Sc. IT — Juin–Juillet 2026
>
> **Statut au 15 septembre 2026** — les Vol. I et II sont **livrables**, le Vol. III **livrable sous réserve déclarée** ([bandeau du volume](3%20-%20EntrepriseAgentique/README.md)), par la décision d'auteur [**D-18**](../2%20-%20Compendium/PRD/PRD.md#d-18) ([registre](../README.md#les-sept-livrables)) ; dépôt **rouvert** le même jour par [D-17](../2%20-%20Compendium/PRD/PRD.md#d-17), re-clôture prévue vers le 8 décembre 2026. *Le bandeau de clôture et la chronique qui suivent restent à leur date : leurs comptes — cinq, sept, huit livrables — valent le jour qu'ils nomment.*
>
> ⚠ **Dépôt clos et final — clôture portée au 1er septembre 2026** — décision d'auteur **D-13**, prise le 8 août 2026 ([`2 - Compendium/PRD/PRD.md`](../2%20-%20Compendium/PRD/PRD.md) v0.17 §16). Aucune passe n'est plus prévue, sur aucun des cinq livrables que le dépôt portait alors ; ce document décrit un état **définitif** pour les trois volumes qu'il couvre. *Clore n'est ni terminer ni publier.* ⚠ **La clôture a été rouverte quatre fois depuis, hors du triptyque** : la veille (8 août), un **sixième livrable** — la [revue de littérature](../3%20-%20Veille/Revue%20de%20litt%C3%A9rature.md), 9 août —, le **calage du compendium à mille pages** (9 août, appareil de rendu du Vol. IV seul) et un **septième livrable** — le [traité sur les systèmes multiagents en essaim](../4%20-%20Essais/1%20-%20Trait%C3%A9/Trait%C3%A9.md), 10 août. ⚠ **Une cinquième réouverture a suivi le 14 août 2026** : le traité passe sous **`3 - Traité/`** — *aujourd'hui [`4 - Essais/1 - Traité/`](../4%20-%20Essais/1%20-%20Trait%C3%A9/)* — et **du code exécutable entre au dépôt** — un simulateur d'essaims en Rust qui transpose ce traité et **contredit trois de ses énoncés par la mesure**. ⚠ **Une sixième le 15 août 2026**, de rangement seul : la veille et la revue passent sous **`4 - Veille/`** — *aujourd'hui [`3 - Veille/`](../3%20-%20Veille/)* —, **quatrième dossier numéroté** — *créé sous le nom `4 - Revue et Veille/` et **renommé `4 - Veille/` le jour même**, commit `71d5388`* —, et `SEBoK.pdf` passe du Vol. IV à [`0 - Références/`](0%20-%20R%C3%A9f%C3%A9rences/) sous le nom `2026 - SystemEngineeringBoK.pdf` — *les cinq fichiers inchangés au bit près*. ⚠ **Une septième les 15-16 août 2026** : les deux livrables de `4 - Veille/` sont **rouverts et re-vérifiés intégralement** — la veille passe à **144 p. / 342 références**, la revue à **59 p. / 192 références**, les deux formats fermes étant levés —, le traité reçoit sa **troisième édition** (15 août, 143 p.), et un **cinquième dossier numéroté** naît le 16 août, `5 - Recension/`, qui porte l'*État de l'art* — ⚠ **un rapport dérivé, et non un huitième livrable**. ⚠ **Une huitième le 17 août 2026** : passe de cohérence sur la totalité des `README.md`, et sur eux seuls. ⚠⚠ **Une neuvième le 19 août 2026, et c'est une destruction** : `5 - Recension/` est **détruit en entier** (commit `7e2409a`, 19 fichiers, 28 806 lignes) — *l'état de l'art, son rendu, sa chaîne, ses figures, son brouillon et son `README.md` ne se relisent plus qu'à l'historique git.* ☑ *Le compte des livrables ne bouge pas : le rapport était dérivé, il n'en était pas un huitième.* **Sept livrables sous quatre dossiers numérotés, au 19 août 2026.** ⚠⚠ **Une dixième le 20 août 2026, et le nom revient sans le contenu** : un dossier `5 - Recension/` **rentre au dépôt** (commit `25e4ea0`, **12 fichiers, 46 970 lignes ajoutées, aucune supprimée**) et porte un *État de l'art* qui n'a rien du précédent — **185 p.**, **312 références** ouvertes en sources primaires (AMF, BSIF, OCRI, Paiements Canada, Loi 25, spécifications MCP / A2A / ANP / AP2) ⚠ *sauf neuf qu'il déclare : cinq auto-citations « Corpus de l'auteur — auto-publié, non arbitré » et quatre notices données pour analyse secondaire*, périmètre d'une **coopérative financière canadienne régie** —, accompagné d'une planche de synthèse de **7 p.** qui explique ses **cinq figures**. *Ce n'est pas un retour : le dossier détruit le 19 ne se relit toujours qu'à l'historique git, et celui-ci n'en descend pas.* ⚠ **Le motif qui excluait le précédent du compte des livrables ne s'applique plus tel quel** — celui-là était dérivé du dépôt, celui-ci **ouvre ses propres sources primaires et ne descend d'aucun livrable**, cite les travaux de l'auteur comme sources externes et renvoie à un autre dépôt que celui-ci ; ⚠⚠ **le compte passe donc de sept à HUIT, et c'est un constat de passe, non une instruction d'auteur** : aucune décision d'auteur ne range ce document parmi les livrables, ce README l'y range sur pièce en donnant son motif, **et le compte se renverse d'un mot de l'auteur.** ⚠ **Un indice joue contre le huitième, et il est déclaré** : le document ne se présente jamais comme une pièce de ce dépôt. ⚠ *Les « sept » écrits plus haut datent l'état d'alors et ne sont pas rétroactivement faux.* **Huit livrables sous cinq dossiers numérotés.** *Aucune des dix ne touche aux Vol. I, II ou III.* ⚠⚠ **UNE ONZIÈME LE 21 AOÛT 2026, ET C'EST LA PREMIÈRE QUI TOUCHE LE TRIPTYQUE** — passe de réparation d'appareil, sur diagnostic, **et rien du fond n'y bouge** : *(a)* ce dossier est renommé `1 - Corpus/` → **`1 - Collection/`** (commit `d786adb`, la veille) et les **trente-huit renvois** que le renommage avait rompus sont réalignés ; *(b)* les **trente pièces de `3 - EntrepriseAgentique/verification/`**, supprimées **par accident** le 8 août 2026 par un commit intitulé « add références » (`659241b`), sont **restaurées depuis l'historique** — elles étaient citées par cent dix renvois du volume, tous morts ; *(c)* l'ancre du Vol. II au `decompte.sh` est **redatée à 93 239**. ☑ *Aucune thèse, aucune pièce de corps, aucun socle, aucun gel n'est touché : ce qui rentre est ce qui avait été perdu, et ce qui change est un chemin ou un chiffre d'appareil.*
>
> ⚠⚠ **CETTE CHRONIQUE S'ARRÊTAIT À LA ONZIÈME RÉOUVERTURE, ET SEPT PASSES ONT SUIVI SANS Y ÊTRE INSCRITES.** *Elles sont ici en bloc, à leur date et à leur commit, sans le détail que les onze premières reçoivent — ce que chacune vaut se lit au [`README` de la racine](../README.md), qui les porte toutes.* **22 août 2026** — validation d'intégrité du `README` de la racine, restauration d'`APPAREIL.md`, et **suppression d'un journal de boucle** de `3 - Traité/` (`4e2ae22`, `997392d`) ; **24 août** — `NiveauMaturité.html` et la **permutation des paliers 4 et 5** (`8223f20`, `0ab655f`, `0d2a77e`) ; **25 août** — la plus chargée, six commits : **révision des titres** du Vol. IV (`8b25090`, *« Interopérabilité et Orchestration en Entreprise Agentique »*), sa datation au PRD et au TOC (`3fc368f`), purge des artefacts hors git (`5ad3c88`), effacement du nom du journal de boucle (`25d621f`) et **retrait des douze rapports d'audit internes** de `3 - Traité/bancs/` (`7a1b7f2`) ; **26 août** — recomposition du Vol. IV pour le **bandeau de couverture** seul (`56cfbfb`) ; **28 août** — entrée de la **note de veille SDLC**, neuvième document publié et **hors livrables** (`9fcc55e`, `f1481ef`, `90ef7d1`) ; ⚠⚠ **1er septembre 2026 — entrée d'un DIXIÈME document et d'un SIXIÈME dossier numéroté**, **`6 - Article/`** — *aujourd'hui [`4 - Essais/2 - Article/`](../4%20-%20Essais/2%20-%20Article/)* — (`da6255b`) : une prépublication au gabarit arXiv de **38 p.** sur l'intégration de processeurs quantiques en plateforme HPC. **C'est le premier dossier numéroté créé depuis le 20 août 2026**, et **le premier document du dépôt qui n'instruise pas la question du corpus** — *la note SDLC est tenue hors des huit livrables pour ce qui lui manque, celui-ci pour ce dont il traite ; son motif est au [`README` de `6 - Article/`](../4%20-%20Essais/2%20-%20Article/README.md), et le PRD ne porte aucune décision sur lui.* ☑ *Le compte des livrables ne bouge pas : **huit livrables sous cinq dossiers numérotés**, et **dix documents publiés sous six**.* ⚠ *Deux des sept touchent des fichiers des Vol. I à III — les deux passes du 25 août, `7a1b7f2` et `3fc368f` —, mais **aucun corps de monographie n'y bouge** : ce sont des `README.md`, des pièces de PRD, de TOC et de `verification/`, réalignés sur le retrait des rapports d'audit du Vol. V et sur le titre neuf du Vol. IV. Le triptyque n'a été touché au fond qu'une fois, le 21 août 2026, et c'était une réparation d'appareil.*
>
>
> ⚠⚠ **UNE PASSE DE PLUS, LE 5 SEPTEMBRE 2026, ET ELLE NE TOUCHE AUCUN CONTENU : L'ARBRE EST RÉORGANISÉ** (commit `daacbec`, « création de 3 - essai. »). **Trois dossiers changent de nom ou de rang, et rien d'autre ne change** — *`git` enregistre des renommages à 100 %, pas un octet de fichier n'est modifié* : `3 - Traité/` → **`4 - Essais/1 - Traité/`**, `4 - Veille/` → **`3 - Veille/`** (le rang 3 se libérant du départ du traité), `6 - Article/` → **`4 - Essais/2 - Article/`**. ☑ **Un dossier de regroupement naît, [`4 - Essais/`](../4%20-%20Essais/), et il porte les deux essais** — le traité avec sa transposition exécutable, et l'article HPC-QPU ; *il ne porte ni `README.md` ni contenu propre, et c'est le seul dossier numéroté du dépôt dans ce cas.* ⚠ **Le compte des dossiers numérotés de premier rang tombe donc de six à CINQ** — `1 - Collection/`, `2 - Compendium/`, `3 - Veille/`, `4 - Essais/`, `5 - Recension/` —, *mais le dépôt en compte toujours six si l'on compte les deux sous-dossiers numérotés des Essais : **le nombre a changé, la matière non.*** ☑ *Le compte des livrables ne bouge pas davantage : **huit livrables**, **dix documents publiés**.* ⚠⚠ **Deux fichiers entrent au même commit, et ils ne sont d'aucun dossier** : `Évaluation académique.md` et son rendu `.html`, à la racine — *une évaluation du dépôt à son état du 4 septembre 2026 (commit `69eeee2`), au régime d'un jury de cycles supérieurs.* ⚠ **Ce n'est ni un livrable ni un document publié de plus** : le document porte sur le dépôt, il n'en instruit pas la question ; le PRD ne porte aucune décision sur lui, et le compte se renverse d'un mot de l'auteur, comme pour la note SDLC et l'article. ⚠ **Ce que la réorganisation a coûté, en revanche, se compte** : les renvois relatifs de tout le dépôt qui visaient les trois anciens chemins sont morts en silence — *aucun contrôle du dépôt ne résout un lien markdown, et c'est le même défaut qui avait laissé mourir trente-deux renvois au renommage du 15 août 2026.* ☑ **Les README de branche ont été repointés le jour même** ; *les mentions d'anciens chemins qui subsistent dans les chroniques datent un état et ne se corrigent pas.*
...
| **Volumétrie** | **570 p.** (7 chapitres + Annexe B, **233 257 mots**) — *569 p. jusqu'au 15 septembre 2026, recomposé ce jour-là sous Typst 0.15.1* | **387 p.** (29 pièces, 92 056 mots) | **427 p.** (34 pièces, **160 890 mots**) |
...
📖 **Documents sources :** [`1 - InteroperabiliteAgentique/Monographie.pdf`](1%20-%20InteroperabiliteAgentique/Monographie.pdf) (**570 p.**, *569 jusqu'au 15 septembre 2026*) · [`Monographie.md`](1%20-%20InteroperabiliteAgentique/Monographie.md)
...
3 septembre 2026 rend faux : la clôture court du 1er septembre, et ce commit lui est antérieur*),
☑ **puis restauré le 21 août 2026** (commit `696bcac`, passe de réparation d'appareil) : le répertoire
[`3 - EntrepriseAgentique/verification/`](3%20-%20EntrepriseAgentique/verification/) et ses
**30 rapports** — 15 lots d'instruction, 11 relectures, 2 revalidations, la confrontation des thèses et
`remontees-gouvernance.md` — **sont sur l'arbre et versionnés**. ⚠⚠ *Ce paragraphe a porté « ne se
lisent plus qu'à l'historique git » deux semaines après leur retour, en contredisant la chronique de
tête de ce même fichier ; les deux faits sont datés, et c'est le **présent** de la phrase qui était
faux.* ⚠ *Le retour des rapports ne solde rien* : les quinze remontées R-G-43 à R-G-57 et la dette de
vote sur F-92 et F-96 restent ouvertes à titre définitif — **le registre qui les détaille est de
nouveau lisible, la dette n'en est pas moins due.** *Un inventaire n'est pas un acquittement.*
...
**Vol. I → Vol. II → Vol. III**, la [veille technologique](../3%20-%20Veille/Veille%20Technologique.md) servant d'entrée rapide ou de mise à jour.

| Profil du lecteur | Point d'entrée recommandé |
|---|---|
| **Pressé** | La [veille technologique](../3%20-%20Veille/Veille%20Technologique.md) (**144 p.**, état de l'art le plus récent — **édition du 15 août 2026**, **342 références** ; *162 p. jusqu'au 8 août 2026, puis 100 p. fermes jusqu'au 15, format ferme levé à la re-vérification intégrale*) — ⚠ *à la racine du dépôt jusqu'au 15 août 2026, sous `4 - Veille/` ensuite, sous [`3 - Veille/`](../3%20-%20Veille/) depuis le 5 septembre 2026* |
...
|---|---|---|---|---|
| **Pages** | 570 *(569 jusqu'au 15 septembre 2026)* | 387 | 427 | **1 384 p.** *(1 383 jusque-là)* |
...
⚠ **Cette commande a ÉCHOUÉ du 8 au 21 août 2026 — sortie 1.** Elle attendait **93 242** mots au
Vol. II et en mesurait **93 239** ; l'agrégat tombait de **479 390** à **479 387**. La cause est le
renommage du volume : le commit `659241b` a récrit, dans **trois pièces de
`2 - OrchestrationAgentique/monographie/`** (§ 6.2, § 13.2, glossaire de l'annexe D), les formules
qui appelaient l'autonomie encadrée le *titre* de l'ouvrage pour en faire sa *thèse*, et **trois
jetons sont tombés**. *(Le script mesure les pièces, non le `Monographie.md` assemblé.)*
☑ **L'ancre a été redatée le 21 août 2026 à 93 239, et la commande sort 0.** *C'est ce que le script
prescrit lui-même en tête de son bloc d'attendus — « s'il bouge, c'est le corpus qui a bougé, et le
chiffre publié qui se redate » — et non une indulgence : le script avait raison, la prose corrigée
aussi, seule l'ancre était périmée. Le chiffre d'avant renommage se relit à `377f8ca`.* ⚠ *Ce
paragraphe portait « personne ne la remettra à jour — le dépôt est clos » : la phrase datait un état,
...
├── 0 - Références/                          ☑ `README.md` + le seul `1997 - Mémoire Maitrise.pdf` (12,2 Mio),
│                                              œuvre de l'auteur. ⚠ Les TROIS ouvrages de tiers qui l'accompagnaient
│                                              — EIP 2003, Distributed Systems 2007, SEBoK 2026, 36,6 Mio — sont
│                                              SORTIS DE L'INDEX le 21 août 2026, la licence CC BY 4.0 de la racine
│                                              ne pouvant pas les couvrir ; disque et historique git les gardent.
│                                              Le régime, longtemps absent, est écrit au `README.md` du dossier
├── 1 - InteroperabiliteAgentique/           Vol. I (570 p. depuis le 15 sept. 2026, 233 257 mots)
...
└── 3 - EntrepriseAgentique/                 Vol. III (427 p., 160 890 mots)
    ...
    ├── verification/                          30 rapports — 15 lots, 11 relectures, 2 revalidations,
    │                                          confrontation des thèses, remontees-gouvernance.md
    │                                          ☑ supprimé le 8 août 2026 (659241b), restauré le 21 (696bcac)
    ├── build/                                 pipeline FESP
    └── Monographie.md / .pdf                  assemblage
```
...
confirme ou qu'elle corrige, ne change aucun état** : le Vol. III demeure **rédigé et non publiable**. ✎ *Ainsi jusqu'au
15 septembre 2026 : la décision D-18 le range ce jour-là parmi les livrables, sous réserve déclarée.*
...
Le compendium — *Interopérabilité et Orchestration en Entreprise Agentique* (titre du 25 août 2026 ; *« Interopérabilité et Orchestration Agentiques en Entreprise »* du 8 au 25 août 2026, *« La somme agentique »* jusque-là), **arrêté en révision finale le 29 juillet 2026, arrêt rouvert le 30, puis **clos par la décision D-13 du 8 août 2026** sans que la passe de révision ait été exécutée, ⚠ *sa clôture étant portée au 1er septembre 2026 le 3 septembre — une décision se date de sa prise, une clôture de l'état qu'elle arrête* — non publiable** —
se situe au [README du dépôt](../README.md) et vit sous
[`2 - Compendium/`](../2%20-%20Compendium/). ✎ *Archive de travail, hors compte des livrables, depuis
le 15 septembre 2026 (D-18) ; le dépôt est rouvert le même jour (D-17).* **Il ne se substitue pas à ces trois volumes tant qu'il
...
veille, de la revue et du traité, entrée de `5 - Recension/` ; renvois à ce cinquième dossier retirés
le 19 août 2026, **jour de sa destruction** ; **un dossier du même nom rentré le 20 août 2026 avec un
tout autre contenu**, consigné à la dixième réouverture ci-dessus — *et nulle part ailleurs dans ce
document, qui ne porte que le triptyque.* **Renvois hors triptyque réalignés une seconde fois le
5 septembre 2026** sur la réorganisation de l'arbre — `3 - Traité/` → `4 - Essais/1 - Traité/`,
