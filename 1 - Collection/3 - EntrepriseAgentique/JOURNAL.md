# Journal — `1 - Collection/3 - EntrepriseAgentique/`
...
Le texte d'origine se relit par `git show 5cdb5bb:"1 - Collection/3 - EntrepriseAgentique/README.md"`. Trois dossiers ont changé de nom le 5 septembre 2026 — `3 - Traité/` est
...
|---|---|---|
| [`README.md`](#page-readme) | 271 | [La thèse](#la-thèse) · [Structure en neuf parties](#structure-en-neuf-parties) · [État](#état) · [Chronique des bandeaux de tête](#chronique-des-bandeaux-de-tête) · [Fichiers cités qui ne sont plus au dépôt — consignés, non corrigés](#fichiers-cités-qui-ne-sont-plus-au-dépôt--consignés-non-corrigés) · [Divergences factuelles portées par ce volume — signalées, jamais tranchées](#divergences-factuelles-portées-par-ce-volume--signalées-jamais-tranchées) · [Structure du dossier](#structure-du-dossier) · [Régénérer le PDF](#régénérer-le-pdf) · [Avertissements](#avertissements) |

<a id="page-readme"></a>

---

*Page reçue : `README.md`, 271 lignes au commit `5cdb5bb`.*
...
8 août 2026 par D-13, et **portée au 1er septembre 2026** le 3 septembre*.
