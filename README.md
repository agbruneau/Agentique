...
commentée ([`TOC.md`](2%20-%20Compendium/PRD/TOC.md), **v0.21 du 27 juillet 2026** — chaque
...
numérotation continue — 50 chapitres en 5 livres, ≈ 369 000 à 394 000 mots projetés. Une fois
...
└── 2 - Compendium/                        ← Vol. IV
    ...
    └── PRD/                                 gouvernance de la rédaction (sous-dossier)
        ├── PRD.md                           v0.5 — portes, régimes de preuve, jalons
        ├── TOC.md                           table des matières commentée (v0.21) — spécification
