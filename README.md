...
commentée ([`TOC.md`](2%20-%20Compendium/PRD/TOC.md), **v0.22 du 27 juillet 2026** — chaque
...
**PRD de gouvernance de la rédaction** ([`PRD.md`](2%20-%20Compendium/PRD/PRD.md), v0.6 du
...
numérotation continue — 51 chapitres en 5 livres, ≈ 376 000 à 401 000 mots projetés (le 51ᵉ est le
**ch. 41, la fabrique d'agents**, entré en v0.22 sur instruction d'auteur : matière neuve sans
volume source, déclarée telle). Une fois
...
└── 2 - Compendium/                        ← Vol. IV
    ...
    └── PRD/                                 gouvernance de la rédaction (sous-dossier)
        ├── PRD.md                           v0.6 — portes, régimes de preuve, jalons
        ├── TOC.md                           table des matières commentée (v0.22) — spécification
