...
| Mesure | **10 pièces** — une ouverture, **8 chapitres**, un sommaire exécutif —, **91 sections**, **9 tableaux** dont quatre numérotés (0.1, 6.1, 8.1, E.1), 2 figures, **50 655 mots de corps**, **128 pages composées**. ⚠ *Le décompte des mots est celui de [`2 - Compendium/PRD/decompte.sh`](../2%20-%20Compendium/PRD/decompte.sh)* — un mot = un jeton portant au moins une lettre ou un chiffre, accents compris — *appliqué au corps, c'est-à-dire à tout ce qui suit le premier `##` et passe donc au PDF*. `wc -w` sur le même corps rend 52 118 : les deux chiffres mesurent deux choses |
