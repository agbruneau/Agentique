...
Le texte d'origine se relit par `git show 5cdb5bb:"3 - Veille/README.md"`. Trois dossiers ont changé de nom le 5 septembre 2026 — `3 - Traité/` est
...
|---|---|---|
| [`README.md`](#page-readme) | 627 | [Les deux livrables](#les-deux-livrables) · [La note de veille SDLC — le troisième document](#la-note-de-veille-sdlc--le-troisième-document) · [Ce que chacun rend à l'autre, et au corpus](#ce-que-chacun-rend-à-lautre-et-au-corpus) · [Construire les PDF](#construire-les-pdf) · [L'appareil de contrôle — [         ](Python/)](#lappareil-de-contrôle-) · [Structure du dossier](#structure-du-dossier) · [Réserves](#réserves) |

<a id="page-readme"></a>

---

*Page reçue : `README.md`, 627 lignes au commit `5cdb5bb`.*
