...
| attestée · autodéclarée · sans revue | VII | régime de publication de la pièce citée, lu à sa notice le 15 août 2026 ; le plus faible l'emporte quand plusieurs pièces sont citées ; la revue n'a rien répliqué (VII §2.3) |
...
2. **Un écart mesuré.** L'adoption précède l'assurance : un audit dynamique de 414 serveurs MCP publics relève 91,8 % de serveurs sans authentification OAuth [VI §7.1, réf. 272 — individuel].
...
5. **Un déficit d'adoption.** Douze brouillons de chaîne de délégation à l'IETF, aucun adopté [VI §7.7 — individuel] ; la revue y aboutit par la littérature : proposer est dépassé, normaliser ne tient pas [VII §15.1, réf. 77, 76, 85 — sans revue].
...
10. **Un calendrier fermé.** E-23 du BSIF et la ligne directrice de l'AMF sur l'IA entrent en vigueur le même jour, le 1er mai 2027 ; aucune échéance n'exige quoi que ce soit des agents, toutes s'appliqueront à eux [VIII §9.12 — individuel].
...
La veille distingue un régime fort — trois vérificateurs indépendants chargés de réfuter chaque énoncé en retournant aux sources primaires — d'un régime faible de contre-vérification individuelle ; les passes du 8 et du 15 août 2026, dont la seconde date l'édition, n'ont comporté aucune ronde adverse [VI §2 — déclaration]. L'audit du 8 août a rouvert une à une les 269 entrées de la bibliographie antérieure : 179 confirmées, 54 corrigées, 30 non reconfirmables, aucune introuvable [VI §2.2 — déclaration]. En dix jours de fenêtre, six énoncés porteurs de l'édition précédente ont été réfutés sur source primaire, dont deux sur le calendrier réglementaire [VI §14 — déclaration]. Ses limites : une littérature primaire faite de prépublications non révisées, des métriques d'adoption auto-déclarées, et des corpus compagnons du même auteur qui comptent pour un seul témoignage [VI §10 — déclaration].
...
**Paiements.** Aucune pièce ne mesure de transaction réelle à valeur réelle sur une pile de paiement agentique en exploitation : tout énoncé sur le comportement des agents payeurs repose sur de la simulation [VII §9.3 — corpus]. **Gouvernance.** La supervision humaine n'est démontrée nulle part comme contrôle effectif : le règlement européen la charge de corriger le biais d'automatisation sans base empirique attestant qu'elle y parvient [VII §11.1, réf. 143 — attestée].
...
| 2 déc. 2027 et 2 août 2028 | règlement européen, haut risque | obligations des annexes III et I, reportées [VIII §12.1 — individuel] |

: Les échéances qui bornent la fenêtre d'une coopérative financière régie, dans l'ordre où elles tombent.

Aucune de ces échéances n'exige quoi que ce soit au sujet des agents ; toutes s'appliqueront à eux [VIII §9.12 — individuel].
...
|:---------------------|:----------------------------------------------------|:---------------------------|
| 414 · 68 · 91,8 % | serveurs MCP publics audités à l'exécution ; vulnérabilités relevées ; part sans authentification OAuth — audit du 31 juillet 2026 | [VI §7.1, réf. 272 — individuel] |
| 40,55 % de 7 973 | serveurs MCP distants exposant des outils sans aucune authentification | [VII §6.1, réf. 81 — sans revue] |
| 41,6 % en trois jours | serveurs confirmés disparus entre deux passes de mesure | [VIII §10.2, réf. 15 — individuel] |
...
| douze, aucun adopté | brouillons individuels de chaîne de délégation à l'IETF | [VI §7.7 — individuel · VIII §7.4.2 — individuel] |
...
| 90 jours · 3 jours · cinq ans | rétention d'historique d'exécution au mieux et par défaut, contre conservation exigée des relevés | [VIII §8.3 — individuel] |
...
| 269 · 179 · 54 · 30 | références rouvertes par l'audit du 8 août 2026 : confirmées, corrigées, non reconfirmables | [VI §2.2 — déclaration] |
